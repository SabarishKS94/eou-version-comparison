...
.slds-tabs_default__nav {
  ...
  border-bottom-color: var(
    ...
    var(--sds-c-tabs-list-color-border, var(--slds-g-color-border-base-4, rgb(229, 229, 229)))
  );
}
.slds-tabs_default__item {
  color: var(
    --slds-c-tabs-item-text-color,
    var(--sds-c-tabs-item-text-color, var(--slds-g-color-neutral-base-30, rgb(68, 68, 68)))
  );
  position: relative;
  padding-top: var(
...
.slds-tabs--default__item:has(:focus-visible) {
  outline: 2px solid var(--slds-g-color-brand-base-40, rgb(11, 92, 171));
...
.slds-tabs_default__item.slds-is-active {
  ...
  --slds-c-tabs-item-text-color: var(
    ...
    var(--sds-c-tabs-item-text-color-active, var(--slds-g-color-neutral-base-10, rgb(24, 24, 24)))
  );
}
...
.slds-tabs_default__item.slds-is-active:after {
  background-color: var(
    ...
    var(--sds-c-tabs-item-color-border-active, rgb(27, 150, 255))
  );
...
.slds-tabs_default__item:hover:after {
  ...
  background-color: var(
    ...
    var(--sds-c-tabs-item-color-border-hover, rgb(1, 118, 211))
  );
}
