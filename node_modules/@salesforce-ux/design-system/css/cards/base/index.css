...
.slds-card {
  ...
  background: var(
    ...
    var(--sds-c-card-color-background, var(--slds-g-color-neutral-base-100, rgb(255, 255, 255)))
  );
  border-width: var(--slds-c-card-sizing-border, var(--sds-c-card-sizing-border, 1px));
  border-style: solid;
  border-color: var(
    --slds-c-card-color-border,
    var(--sds-c-card-color-border, var(--slds-g-color-border-base-1, rgb(201, 201, 201)))
  );
...
.slds-card__footer {
  ...
  border-top-color: var(
    ...
    var(--sds-c-card-footer-color-border, var(--slds-g-color-border-base-1, rgb(201, 201, 201)))
  );
}
