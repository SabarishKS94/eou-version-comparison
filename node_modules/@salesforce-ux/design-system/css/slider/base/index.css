...
.slds-slider__range::-webkit-slider-thumb {
  ...
  background-color: var(
    ...
    var(--sds-c-slider-thumb-color-foreground, rgb(1, 118, 211))
  );
  border: 0;
...
.slds-slider__range::-webkit-slider-thumb:hover {
  background-color: var(
    ...
    var(--sds-c-slider-thumb-color-foreground-hover, rgb(1, 68, 134))
  );
}
.slds-slider__range::-webkit-slider-runnable-track {
  ...
  background-color: var(
    ...
    var(--sds-c-slider-track-color-background, var(--slds-g-color-neutral-base-95, rgb(243, 243, 243)))
  );
...
.slds-slider__range:focus::-webkit-slider-thumb {
  background-color: var(
    ...
    var(--sds-c-slider-thumb-color-foreground-focus, rgb(1, 68, 134))
  );
  -webkit-box-shadow: var(
...
.slds-slider__range:active::-webkit-slider-thumb {
  background-color: var(
    ...
    var(--sds-c-slider-thumb-color-foreground-active, rgb(1, 68, 134))
  );
}
