...
.slds-button_dual-stateful.slds-is-pressed {
  ...
  --slds-c-button-color-background: var(
    ...
    var(--slds-c-button-brand-color-background, var(--sds-c-button-brand-color-background, rgb(1, 118, 211)))
  );
  /*! @css-var-fallback border-color */
  --slds-c-button-color-border: var(
    --slds-c-button-dual-stateful-color-border-selected,
    var(--slds-c-button-brand-color-border, var(--sds-c-button-brand-color-border, rgb(1, 118, 211)))
  );
  ...
  --slds-c-button-text-color-hover: var(
    ...
    var(
      ...
      var(--sds-c-button-brand-text-color-hover, var(--slds-g-color-neutral-base-100, rgb(255, 255, 255)))
    )
  );
}
...
.slds-button_dual-stateful.slds-is-pressed:hover {
  ...
  --slds-c-button-dual-stateful-color-background-selected: var(
    ...
    var(--slds-c-button-brand-color-background-hover, var(--sds-c-button-brand-color-background-hover, rgb(1, 68, 134)))
  );
  /*! @css-var-fallback border-color */
  --slds-c-button-dual-stateful-color-border-selected: var(
    --slds-c-button-dual-stateful-color-border-selected-hover,
    var(--slds-c-button-brand-color-border-hover, var(--sds-c-button-brand-color-border-hover, rgb(1, 68, 134)))
  );
  /*! @css-var-fallback color */
