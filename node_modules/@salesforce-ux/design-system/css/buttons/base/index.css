...
.slds-button {
  ...
  color: var(--slds-c-button-text-color, var(--sds-c-button-text-color, rgb(1, 118, 211)));
...
.slds-button:focus {
  ...
  color: var(--slds-c-button-text-color-hover, var(--sds-c-button-text-color-hover, rgb(1, 68, 134)));
}
.slds-button:focus {
...
.slds-button:active {
  color: var(--slds-c-button-text-color-active, var(--sds-c-button-text-color-active, rgb(1, 68, 134)));
...
a.slds-button--brand:focus {
  color: var(
    ...
    var(
      ...
      var(--slds-g-link-text-color-hover, var(--slds-g-color-neutral-base-100, rgb(255, 255, 255)))
    )
  );
}
...
a.slds-button--destructive:focus {
  color: var(
    ...
    var(--sds-c-button-destructive-text-color, var(--slds-g-color-neutral-base-100, rgb(255, 255, 255)))
  );
}
...
a.slds-button_text-destructive:focus {
  color: var(
    ...
    var(--sds-c-button-text-destructive-text-color-hover, var(--slds-g-color-error-base-30, rgb(186, 5, 23)))
  );
}
...
a.slds-button--success:focus {
  color: var(
    ...
    var(--sds-c-button-success-text-color-hover, var(--slds-g-color-neutral-base-100, rgb(255, 255, 255)))
  );
}
...
a.slds-button--inverse:focus {
  ...
  --slds-c-button-color-border: var(
    ...
    var(--sds-c-button-inverse-color-border-focus, var(--slds-g-color-neutral-base-100, rgb(243, 243, 243)))
  );
  /*! @css-var-fallback box-shadow */
...
.slds-button_neutral {
  ...
  --slds-c-button-color-background: var(
    ...
    var(--sds-c-button-neutral-color-background, var(--slds-g-color-neutral-base-100, rgb(255, 255, 255)))
  );
  /*! @css-var-fallback border-color */
  --slds-c-button-color-border: var(
    --slds-c-button-neutral-color-border,
    var(--sds-c-button-neutral-color-border, var(--slds-g-color-border-base-4, rgb(201, 201, 201)))
  );
}
...
.slds-button_neutral:focus {
  ...
  --slds-c-button-color-background-hover: var(
    ...
    var(--sds-c-button-neutral-color-background-hover, var(--slds-g-color-neutral-base-95, rgb(243, 243, 243)))
  );
  /*! @css-var-fallback border-color */
  --slds-c-button-color-border-hover: var(
    --slds-c-button-neutral-color-border-hover,
    var(--sds-c-button-neutral-color-border-hover, var(--slds-g-color-border-base-4, rgb(201, 201, 201)))
  );
}
.slds-button_neutral:active {
  ...
  --slds-c-button-color-background-active: var(
    ...
    var(--sds-c-button-neutral-color-background-active, var(--slds-g-color-neutral-base-95, rgb(243, 243, 243)))
  );
  /*! @css-var-fallback border-color */
  --slds-c-button-color-border-active: var(
    --slds-c-button-neutral-color-border-active,
    var(--sds-c-button-neutral-color-border-active, var(--slds-g-color-border-base-4, rgb(201, 201, 201)))
  );
}
...
.slds-button_brand {
  ...
  --slds-c-button-color-background: var(
    ...
    var(--sds-c-button-brand-color-background, rgb(1, 118, 211))
  );
  /*! @css-var-fallback border-color */
  --slds-c-button-color-border: var(
    --slds-c-button-brand-color-border,
    var(--sds-c-button-brand-color-border, rgb(1, 118, 211))
  );
  /*! @css-var-fallback color */
  --slds-c-button-text-color: var(
    --slds-c-button-brand-text-color,
    var(--sds-c-button-brand-text-color, var(--slds-g-color-neutral-base-100, rgb(255, 255, 255)))
  );
}
...
.slds-button_brand:focus {
  ...
  --slds-c-button-color-background-hover: var(
    ...
    var(--sds-c-button-brand-color-background-hover, rgb(1, 68, 134))
  );
  /*! @css-var-fallback border-color */
  --slds-c-button-color-border-hover: var(
    --slds-c-button-brand-color-border-hover,
    var(--sds-c-button-brand-color-border-hover, rgb(1, 68, 134))
  );
  /*! @css-var-fallback color */
  --slds-c-button-text-color-hover: var(
    --slds-c-button-brand-text-color-hover,
    var(--sds-c-button-brand-text-color-hover, var(--slds-g-link-text-color-hover, rgb(255, 255, 255)))
  );
}
.slds-button_brand:active {
  ...
  --slds-c-button-color-background-active: var(
    ...
    var(--sds-c-button-brand-color-background-active, rgb(1, 68, 134))
  );
  /*! @css-var-fallback border-color */
  --slds-c-button-color-border-active: var(
    --slds-c-button-brand-color-border-active,
    var(--sds-c-button-brand-color-border-active, rgb(1, 68, 134))
  );
  /*! @css-var-fallback color */
  --slds-c-button-text-color-active: var(
    --slds-c-button-brand-text-color-active,
    var(--sds-c-button-brand-text-color-active, var(--slds-g-color-neutral-base-100, rgb(255, 255, 255)))
  );
}
...
.slds-button_outline-brand {
  ...
  --slds-c-button-color-background: var(
    ...
    var(--sds-c-button-outline-brand-color-background, var(--slds-g-color-neutral-base-100, rgb(255, 255, 255)))
  );
  /*! @css-var-fallback border-color */
  --slds-c-button-color-border: var(
    --slds-c-button-outline-brand-color-border,
    var(--sds-c-button-outline-brand-color-border, rgb(1, 118, 211))
  );
}
...
.slds-button_outline-brand:focus {
  ...
  --slds-c-button-color-background-hover: var(
    ...
    var(--sds-c-button-outline-brand-color-background-hover, var(--slds-g-color-neutral-base-95, rgb(243, 243, 243)))
  );
  /*! @css-var-fallback border-color */
  --slds-c-button-color-border-hover: var(
    --slds-c-button-outline-brand-color-border-hover,
    var(--sds-c-button-outline-brand-color-border-hover, rgb(1, 118, 211))
  );
}
.slds-button_outline-brand:active {
  ...
  --slds-c-button-color-background-active: var(
    ...
    var(--sds-c-button-outline-brand-color-background-active, var(--slds-g-color-neutral-base-95, rgb(243, 243, 243)))
  );
  /*! @css-var-fallback border-color */
  --slds-c-button-color-border-active: var(
    --slds-c-button-outline-brand-color-border-active,
    var(--sds-c-button-outline-brand-color-border-active, rgb(1, 118, 211))
  );
}
...
.slds-button_inverse {
  ...
  --slds-c-button-color-border: var(
    ...
    var(--sds-c-button-inverse-color-border, var(--slds-g-color-border-base-4, rgb(201, 201, 201)))
  );
}
...
.slds-button_inverse:focus {
  ...
  --slds-c-button-color-background-hover: var(
    ...
    var(--sds-c-button-inverse-color-background-hover, var(--slds-g-color-neutral-base-95, rgb(243, 243, 243)))
  );
  /*! @css-var-fallback border-color */
  --slds-c-button-color-border-hover: var(
    --slds-c-button-inverse-color-border-hover,
    var(--sds-c-button-inverse-color-border-hover, var(--slds-g-color-border-base-4, rgb(201, 201, 201)))
  );
}
.slds-button_inverse:focus {
...
.slds-button_inverse:active {
  ...
  --slds-c-button-color-background-active: var(
    ...
    var(--sds-c-button-inverse-color-background-active, var(--slds-g-color-neutral-base-95, rgb(243, 243, 243)))
  );
  /*! @css-var-fallback border-color */
  --slds-c-button-color-border-active: var(
    --slds-c-button-inverse-color-border-active,
    var(--sds-c-button-inverse-color-border-active, var(--slds-g-color-border-base-4, rgb(201, 201, 201)))
  );
}
...
.slds-button_icon-border-inverse:visited {
  ...
  --slds-c-button-text-color: var(
    ...
    var(--sds-c-button-inverse-text-color, var(--slds-g-color-neutral-base-100, rgb(243, 243, 243)))
  );
}
.slds-button_inverse:hover,
.slds-button_inverse:focus,
...
.slds-button_icon-border-inverse:focus {
  ...
  --slds-c-button-text-color-hover: var(
    ...
    var(--sds-c-button-inverse-text-color-hover, var(--slds-g-link-color, rgb(1, 118, 211)))
  );
}
.slds-button_inverse:focus,
.slds-button_icon-border-inverse:focus {
  ...
  /*! @css-var-fallback border-color */
  --slds-c-button-color-border: var(--slds-g-color-neutral-base-100, rgb(243, 243, 243));
  outline: none;
}
.slds-button_inverse:active,
.slds-button_icon-border-inverse:active {
  ...
  --slds-c-button-text-color-active: var(
    ...
    var(--sds-c-button-inverse-text-color-active, var(--slds-g-link-color, rgb(1, 118, 211)))
  );
}
.slds-button_inverse[disabled],
.slds-button_inverse:disabled,
...
.slds-button_destructive {
  ...
  --slds-c-button-color-background: var(
    ...
    var(--sds-c-button-destructive-color-background, var(--slds-g-color-error-base-40, rgb(186, 5, 23)))
  );
  /*! @css-var-fallback border-color */
  --slds-c-button-color-border: var(
    --slds-c-button-destructive-color-border,
    var(--sds-c-button-destructive-color-border, var(--slds-g-color-error-base-40, rgb(186, 5, 23)))
  );
  /*! @css-var-fallback color */
  --slds-c-button-text-color: var(
    --slds-c-button-destructive-text-color,
...
.slds-button_destructive:focus {
  ...
  --slds-c-button-color-background-hover: var(
    ...
    var(--sds-c-button-destructive-color-background-hover, var(--slds-g-color-error-base-30, rgb(142, 3, 15)))
  );
  /*! @css-var-fallback border-color */
  --slds-c-button-color-border-hover: var(
  ...
  --slds-c-button-text-color-hover: var(
    ...
    var(--sds-c-button-destructive-text-color-hover, var(--slds-g-color-neutral-base-100, rgb(255, 255, 255)))
  );
}
.slds-button_destructive:active {
  ...
  --slds-c-button-color-background-active: var(
    ...
    var(--sds-c-button-destructive-color-background-active, var(--slds-g-color-error-base-30, rgb(142, 3, 15)))
  );
  /*! @css-var-fallback border-color */
  --slds-c-button-color-border-active: var(
    --slds-c-button-destructive-color-border-active,
    var(--sds-c-button-destructive-color-border-active, var(--slds-g-color-error-base-30, rgb(142, 3, 15)))
  );
  /*! @css-var-fallback color */
  --slds-c-button-text-color-active: var(
    --slds-c-button-destructive-text-color-active,
    var(--sds-c-button-destructive-text-color-active, var(--slds-g-color-neutral-base-100, rgb(255, 255, 255)))
  );
}
...
.slds-button_text-destructive {
  ...
  --slds-c-button-color-background: var(
    ...
    var(--sds-c-button-text-destructive-color-background, var(--slds-g-color-neutral-base-100, rgb(255, 255, 255)))
  );
  /*! @css-var-fallback border-color */
  --slds-c-button-color-border: var(
    --slds-c-button-text-destructive-color-border,
    var(--sds-c-button-text-destructive-color-border, var(--slds-g-color-border-base-4, rgb(201, 201, 201)))
  );
  /*! @css-var-fallback color */
  --slds-c-button-text-color: var(
    --slds-c-button-text-destructive-text-color,
    var(--sds-c-button-text-destructive-text-color, var(--slds-g-color-error-base-30, rgb(234, 0, 30)))
  );
}
...
.slds-button_text-destructive:focus {
  ...
  --slds-c-button-color-background-hover: var(
    ...
    var(--sds-c-button-text-destructive-color-background-hover, var(--slds-g-color-neutral-base-95, rgb(243, 243, 243)))
  );
  /*! @css-var-fallback border-color */
  --slds-c-button-color-border-hover: var(
    --slds-c-button-text-destructive-color-border-hover,
    var(--sds-c-button-text-destructive-color-border-hover, var(--slds-g-color-border-base-4, rgb(201, 201, 201)))
  );
  /*! @css-var-fallback color */
  --slds-c-button-text-color-hover: var(
...
.slds-button_text-destructive:active {
  ...
  --slds-c-button-color-border-active: var(
    ...
    var(--sds-c-button-text-destructive-color-border-active, var(--slds-g-color-border-base-4, rgb(201, 201, 201)))
  );
  /*! @css-var-fallback color */
  --slds-c-button-text-color-active: var(
    --slds-c-button-text-destructive-text-color-active,
    var(--sds-c-button-text-destructive-text-color-active, var(--slds-g-color-error-base-30, rgb(186, 5, 23)))
  );
}
...
.slds-button_success {
  ...
  --slds-c-button-color-background: var(
    ...
    var(--sds-c-button-success-color-background, var(--slds-g-color-success-base-70, rgb(69, 198, 90)))
  );
  /*! @css-var-fallback border-color */
  --slds-c-button-color-border: var(
    --slds-c-button-success-color-border,
    var(--sds-c-button-success-color-border, var(--slds-g-color-success-base-50, rgb(145, 219, 139)))
  );
  /*! @css-var-fallback color */
  --slds-c-button-text-color: var(
    --slds-c-button-success-text-color,
    var(--sds-c-button-success-text-color, var(--slds-g-color-neutral-base-10, rgb(24, 24, 24)))
  );
}
...
.slds-button_success:focus {
  ...
  --slds-c-button-color-background-hover: var(
    ...
    var(--sds-c-button-success-color-background-hover, var(--slds-g-color-success-base-50, rgb(46, 132, 74)))
  );
  /*! @css-var-fallback border-color */
  --slds-c-button-color-border-hover: var(
    --slds-c-button-success-color-border-hover,
    var(--sds-c-button-success-color-border-hover, var(--slds-g-color-success-base-50, rgb(46, 132, 74)))
  );
  /*! @css-var-fallback color */
  --slds-c-button-text-color-hover: var(
    --slds-c-button-success-text-color-hover,
...
.slds-button_success:active {
  ...
  --slds-c-button-color-background-active: var(
    ...
    var(--sds-c-button-success-color-background-active, var(--slds-g-color-success-base-50, rgb(46, 132, 74)))
  );
  /*! @css-var-fallback border-color */
  --slds-c-button-color-border-active: var(
    --slds-c-button-success-color-border-active,
    var(--sds-c-button-success-color-border-active, var(--slds-g-color-success-base-50, rgb(46, 132, 74)))
  );
  /*! @css-var-fallback color */
  --slds-c-button-text-color-active: var(
    --slds-c-button-success-text-color-active,
    var(--sds-c-button-success-text-color-active, var(--slds-g-color-neutral-base-100, rgb(255, 255, 255)))
  );
}
