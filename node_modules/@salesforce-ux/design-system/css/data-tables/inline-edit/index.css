...
.slds-table_edit_container:focus:before {
  ...
  -webkit-box-shadow: 0 0 0 4px var(--slds-g-color-border-brand-2, rgb(27, 150, 255)) inset;
  box-shadow: 0 0 0 4px var(--slds-g-color-border-brand-2, rgb(27, 150, 255)) inset;
}
...
.slds-table_edit:not(.slds-no-cell-focus) tbody tr:hover > .slds-cell-edit.slds-has-focus {
  background-color: var(--slds-g-color-neutral-base-100, rgb(255, 255, 255));
  -webkit-box-shadow: rgb(1, 118, 211) 0 0 0 1px inset;
  box-shadow: rgb(1, 118, 211) 0 0 0 1px inset;
}
...
.slds-table_edit.slds-table tbody tr:hover > .slds-cell-edit.slds-has-error {
  background-color: var(--slds-g-color-palette-yellow-90, rgb(250, 255, 189));
  -webkit-box-shadow: var(--slds-g-color-error-base-40, rgb(234, 0, 30)) 0 0 0 2px inset;
...
.slds-has-focus .slds-th__action {
  background-color: var(--slds-g-color-neutral-base-100, rgb(255, 255, 255));
  -webkit-box-shadow: rgb(1, 68, 134) 0 0 0 1px inset;
  box-shadow: rgb(1, 68, 134) 0 0 0 1px inset;
}
...
.slds-is-resizable .slds-th__action:focus:hover {
  background-color: var(--slds-g-color-neutral-base-100, rgb(255, 255, 255));
  -webkit-box-shadow: rgb(1, 68, 134) 0 0 0 1px inset, rgb(1, 68, 134) -0.25rem 0 0 inset;
  box-shadow: rgb(1, 68, 134) 0 0 0 1px inset, rgb(1, 68, 134) -0.25rem 0 0 inset;
}
...
.slds-no-cell-focus .slds-has-focus.slds-is-resizable:hover .slds-th__action {
  background-color: var(--slds-g-color-neutral-base-100, rgb(255, 255, 255));
  -webkit-box-shadow: var(--slds-g-color-border-base-1, rgb(229, 229, 229)) -0.25rem 0 0 inset;
  box-shadow: var(--slds-g-color-border-base-1, rgb(229, 229, 229)) -0.25rem 0 0 inset;
}
...
.slds-no-cell-focus thead .slds-has-focus:hover {
  color: var(--slds-g-link-color, rgb(11, 92, 171));
}
.slds-no-cell-focus thead .slds-has-focus:hover .slds-is-sortable__icon {
  display: inline-block;
  fill: var(--slds-g-link-color, rgb(11, 92, 171));
}
