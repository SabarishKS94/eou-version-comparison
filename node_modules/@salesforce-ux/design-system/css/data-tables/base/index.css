...
.slds-table:not(.slds-no-row-hover) tr.slds-is-selected:hover a {
  color: var(--slds-g-link-color-focus, rgb(3, 45, 96));
}
...
.slds-table_bordered:not(.slds-no-row-hover) tbody tr:focus > th:not(.slds-has-focus) > th:not(.slds-has-focus) {
  -webkit-box-shadow: var(--slds-g-color-border-base-1, rgb(229, 229, 229)) 0 -1px 0 inset,
...
[class*="slds-table_column-"] tr td .slds-truncate:after {
  ...
  background: -webkit-gradient(
    ...
    right top,
    from(transparent),
    color-stop(69%, var(--slds-g-color-neutral-base-100, rgb(255, 255, 255)))
  );
  background: linear-gradient(to right, transparent 0%, var(--slds-g-color-neutral-base-100, rgb(255, 255, 255)) 69%);
}
...
[class*="slds-table_column-"] tr:hover td .slds-truncate:after {
  background: -webkit-gradient(
    ...
    color-stop(69%, rgb(250, 250, 249))
  );
  background: linear-gradient(to right, rgba(250, 250, 249, 0) 0%, rgb(250, 250, 249) 69%);
}
