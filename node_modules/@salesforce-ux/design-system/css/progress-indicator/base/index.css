...
.slds-progress .slds-progress-bar {
  ...
  background: var(--slds-g-color-neutral-base-50, rgb(201, 201, 201));
}
...
.slds-progress_shade .slds-progress__item.slds-is-active .slds-progress__marker {
  -webkit-box-shadow: var(--slds-g-color-neutral-base-95, rgb(243, 243, 243)) 0 0 0 4px;
...
.slds-progress__item.slds-is-completed .slds-progress__marker_icon {
  ...
  color: var(--slds-g-color-brand-base-50, rgb(26, 185, 255));
}
.slds-progress__item.slds-is-active .slds-progress__marker {
  -webkit-box-shadow: var(--slds-g-color-neutral-base-100, rgb(255, 255, 255)) 0 0 0 4px;
