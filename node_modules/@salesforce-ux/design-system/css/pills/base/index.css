...
.slds-pill {
  ...
  border-color: var(
    ...
    var(--sds-c-pill-color-border, var(--slds-g-color-border-base-4, rgb(229, 229, 229)))
  );
  border-radius: var(--slds-c-pill-radius-border, var(--sds-c-pill-radius-border, 0.25rem));
  background-color: var(
    --slds-c-pill-color-background,
    var(--sds-c-pill-color-background, var(--slds-g-color-neutral-base-100, rgb(255, 255, 255)))
  );
...
.slds-pill:hover {
  ...
  --slds-c-pill-color-background: var(
    ...
    var(--sds-c-pill-color-background-hover, var(--slds-g-color-neutral-base-95, rgb(243, 243, 243)))
  );
}
.slds-pill:focus {
...
.slds-pill_container {
  ...
  background-color: var(
    ...
    var(--sds-c-pill-container-color-background, var(--slds-g-color-neutral-base-100, rgb(255, 255, 255)))
  );
}
...
.slds-has-error {
  border-color: var(
    ...
    var(--sds-c-pill-error-color-border, var(--slds-g-color-error-base-40, rgb(234, 0, 30)))
  );
}
.slds-has-error:active {
  border-color: var(
    --slds-c-pill-error-color-border-active,
    var(--sds-c-pill-error-color-border-active, var(--slds-g-color-error-base-40, rgb(234, 0, 30)))
  );
}
.slds-has-error .slds-pill__label {
  ...
  color: var(
    ...
    var(
      ...
      var(--sds-c-pill-error-text-color, var(--slds-g-color-error-base-40, rgb(234, 0, 30)))
    )
  );
}
.slds-has-error:hover {
  --slds-c-pill-error-text-color: var(--slds-g-color-error-base-30, rgb(234, 0, 30));
}
.slds-has-error:hover .slds-pill__icon_container .slds-icon-text-error {
  --slds-c-icon-color-foreground: var(--slds-g-color-error-base-30, rgb(234, 0, 30));
}
