...
.slds-tree [role="treeitem"][aria-selected="true"]:focus > .slds-tree__item {
  -webkit-box-shadow: rgb(27, 150, 255) 4px 0 0 inset,
    0 0 0 2px var(--slds-g-color-neutral-base-100, rgb(255, 255, 255)),
    0 0 0 4px var(--slds-g-color-brand-base-40, rgb(11, 92, 171));
  box-shadow: rgb(27, 150, 255) 4px 0 0 inset, 0 0 0 2px var(--slds-g-color-neutral-base-100, rgb(255, 255, 255)),
    0 0 0 4px var(--slds-g-color-brand-base-40, rgb(11, 92, 171));
}
...
.slds-tree [role="treeitem"][aria-selected="true"] > .slds-tree__item {
  ...
  -webkit-box-shadow: rgb(27, 150, 255) 4px 0 0 inset;
  box-shadow: rgb(27, 150, 255) 4px 0 0 inset;
}
