...
.slds-checkbox_toggle .slds-checkbox_faux {
  ...
  border-color: var(
    ...
    var(--sds-c-checkbox-toggle-color-border, var(--slds-g-color-neutral-base-60, rgb(174, 174, 174)))
  );
  padding: 0.125rem;
  background-color: var(
    --slds-c-checkbox-toggle-color-background,
    var(--sds-c-checkbox-toggle-color-background, var(--slds-g-color-neutral-base-60, rgb(174, 174, 174)))
  );
...
.slds-checkbox_toggle .slds-checkbox_faux:focus {
  ...
  --slds-c-checkbox-toggle-color-background: var(
    ...
    var(--sds-c-checkbox-toggle-color-background-hover, var(--slds-g-color-neutral-base-50, rgb(147, 147, 147)))
  );
...
.slds-checkbox_toggle .slds-checkbox_faux:after {
  ...
  background-color: var(
    ...
    var(--sds-c-checkbox-toggle-switch-color-background, var(--slds-g-color-neutral-base-100, rgb(255, 255, 255)))
  );
  border-radius: var(--slds-c-checkbox-toggle-radius-border, var(--sds-c-checkbox-toggle-radius-border, 15rem));
}
...
.slds-checkbox_toggle [type="checkbox"]:focus + .slds-checkbox_faux_container .slds-checkbox_faux {
  ...
  --slds-c-checkbox-toggle-color-background: var(
    ...
    var(--sds-c-checkbox-toggle-color-background-focus, var(--slds-g-color-neutral-base-50, rgb(147, 147, 147)))
  );
...
.slds-checkbox_toggle [type="checkbox"]:checked + .slds-checkbox_faux_container .slds-checkbox_faux {
  ...
  --slds-c-checkbox-toggle-color-border: var(
    ...
    var(--sds-c-checkbox-toggle-color-border-checked, rgb(1, 118, 211))
  );
  /*! @css-var-fallback background-color */
  --slds-c-checkbox-toggle-color-background: var(
    --slds-c-checkbox-toggle-color-background-checked,
    var(--sds-c-checkbox-toggle-color-background-checked, rgb(1, 118, 211))
  );
}
...
.slds-checkbox_toggle [type="checkbox"]:checked + .slds-checkbox_faux_container .slds-checkbox_faux:focus {
  ...
  --slds-c-checkbox-toggle-color-background: var(
    ...
    var(--sds-c-checkbox-toggle-color-background-checked-hover, rgb(1, 68, 134))
  );
}
...
.slds-checkbox_toggle [type="checkbox"]:checked + .slds-checkbox_faux_container .slds-checkbox_faux:before {
  ...
  background-color: var(
    ...
    var(
      ...
      var(
        --slds-c-checkbox-toggle-switch-color-background,
        var(--sds-c-checkbox-toggle-switch-color-background, rgb(255, 255, 255))
      )
    )
  );
  border-radius: var(--slds-c-checkbox-toggle-radius-border, var(--sds-c-checkbox-toggle-radius-border, 15rem));
...
.slds-checkbox_toggle [type="checkbox"]:checked + .slds-checkbox_faux_container .slds-checkbox_faux:after {
  ...
  border-bottom-color: var(
    ...
    var(--sds-c-checkbox-toggle-mark-color-foreground, var(--slds-g-color-neutral-base-100, rgb(255, 255, 255)))
  );
  /*! @noflip */
...
.slds-checkbox_toggle [type="checkbox"]:checked:focus + .slds-checkbox_faux_container .slds-checkbox_faux {
  ...
  --slds-c-checkbox-toggle-color-background: var(
    ...
    var(--sds-c-checkbox-toggle-color-background-checked-focus, rgb(1, 68, 134))
  );
}
