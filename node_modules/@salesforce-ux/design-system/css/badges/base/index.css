...
.slds-badge {
  ...
  color: var(
    ...
    var(--sds-c-badge-text-color, var(--slds-g-color-neutral-base-10, rgb(24, 24, 24)))
  );
  ...
  background-color: var(
    ...
    var(--sds-c-badge-color-background, var(--slds-g-color-neutral-base-95, rgb(243, 243, 243)))
  );
}
...
.slds-badge_inverse {
  ...
  --slds-c-badge-color-background: var(
    ...
    var(--sds-c-badge-inverse-color-background, var(--slds-g-color-neutral-base-50, rgb(116, 116, 116)))
  );
  /*! @css-var-fallback color */
  --slds-c-badge-text-color: var(
    --slds-c-badge-inverse-text-color,
    var(--sds-c-badge-inverse-text-color, var(--slds-g-color-neutral-base-100, rgb(255, 255, 255)))
  );
}
.slds-badge_lightest {
  /*! @css-var-fallback background-color */
  --slds-c-badge-color-background: var(
    ...
    var(--sds-c-badge-lightest-color-background, var(--slds-g-color-neutral-base-100, rgb(255, 255, 255)))
  );
  /*! @css-var-fallback border-color */
  --slds-c-badge-color-border: var(
    --slds-c-badge-lightest-color-border,
    var(--sds-c-badge-lightest-color-border, var(--slds-g-color-border-base-1, rgb(229, 229, 229)))
  );
}
.slds-badge__icon {
  display: -webkit-inline-box;
  ...
  color: var(
    ...
    var(--sds-c-badge-icon-color-foreground, var(--slds-g-color-neutral-base-50, rgb(116, 116, 116)))
  );
  line-height: 1;
