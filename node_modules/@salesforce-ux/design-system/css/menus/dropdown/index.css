...
.slds-dropdown {
  ...
  color: var(--slds-c-dropdown-color, var(--slds-g-color-neutral-base-10, rgb(24, 24, 24)));
}
.slds-dropdown mark {
  font-weight: 700;
...
.slds-dropdown__item > a {
  ...
  color: var(--slds-c-dropdown-item-color, var(--slds-g-color-neutral-base-10, rgb(24, 24, 24)));
  cursor: pointer;
}
...
.slds-dropdown__item > a[aria-disabled="true"]:focus {
  ...
  color: var(--slds-c-dropdown-item-color-disabled, var(--slds-g-color-neutral-base-80, rgb(201, 201, 201)));
}
.slds-dropdown__item > a[aria-disabled="true"]:focus {
