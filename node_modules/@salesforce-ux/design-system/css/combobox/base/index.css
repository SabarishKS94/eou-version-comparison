...
.slds-combobox_container.slds-has-selection .slds-combobox__input-value:focus {
  -webkit-box-shadow: 0 0 0 2px var(--slds-g-color-neutral-base-100, rgb(255, 255, 255)) inset,
    0 0 0 3px var(--slds-g-color-border-base-1, rgb(229, 229, 229)) inset;
  box-shadow: 0 0 0 2px var(--slds-g-color-neutral-base-100, rgb(255, 255, 255)) inset,
    0 0 0 3px var(--slds-g-color-border-base-1, rgb(229, 229, 229)) inset;
}
.slds-combobox_container.slds-has-selection .slds-combobox__input-value:focus {
...
.slds-listbox__option[aria-disabled="true"]:focus {
  color: var(--slds-c-listbox-option-color-disabled, var(--slds-g-color-neutral-base-50, rgb(201, 201, 201)));
...
.slds-listbox__option-meta {
  display: block;
  margin-top: -0.25rem;
  color: var(--slds-c-listbox-option-meta-color, var(--slds-g-color-neutral-base-30, rgb(68, 68, 68)));
}
