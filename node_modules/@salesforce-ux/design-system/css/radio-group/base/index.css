...
.slds-radio .slds-radio_faux {
  ...
  border: 1px solid
    var(
      ...
      var(--sds-c-radio-color-border, var(--slds-g-color-border-base-4, rgb(201, 201, 201)))
    );
  border-radius: 50%;
  background: none;
  background-color: var(
    --slds-c-radio-color-background,
    var(--sds-c-radio-color-background, var(--slds-g-color-neutral-base-100, rgb(255, 255, 255)))
  );
...
.slds-radio [type="radio"]:checked + .slds-radio__label .slds-radio_faux:after {
  ...
  background-color: var(
    ...
    var(--sds-c-radio-mark-color-foreground, var(--slds-s-mark-color-foreground-checked, rgb(1, 118, 211)))
  );
}
...
.slds-radio [type="radio"]:focus + .slds-radio__label .slds-radio_faux {
  border-color: var(
    ...
    var(--slds-c-radio-color-border-focus, var(--slds-g-color-border-base-4, rgb(201, 201, 201)))
  );
