...
.slds-brand-band:before {
  ...
  background-image: url("../images/themes/oneSalesforce/banner-brand-default.png"),
    -webkit-gradient(linear, left bottom, left top, color-stop(0, rgba(1, 68, 134, 0)), to(rgb(1, 68, 134)));
  background-image: url("../images/themes/oneSalesforce/banner-brand-default.png"),
    linear-gradient(to top, rgba(1, 68, 134, 0) 0, rgb(1, 68, 134));
...
.slds-brand-band:after {
  ...
  background-image: linear-gradient(to bottom, rgba(176, 196, 223, 0) 60%, rgb(238, 244, 255));
}
