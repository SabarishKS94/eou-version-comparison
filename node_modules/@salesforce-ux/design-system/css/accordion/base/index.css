...
.slds-accordion__list-item {
  ...
  border-top-color: var(
    ...
    var(
      ...
      var(--sds-c-accordion-color-border, var(--slds-g-color-border-base-1, rgb(229, 229, 229)))
    )
  );
}
...
.slds-accordion__summary-heading {
  ...
  color: var(
    ...
    var(
      ...
      var(--sds-c-accordion-heading-text-color, var(--slds-g-color-neutral-base-10, rgb(24, 24, 24)))
    )
  );
...
.slds-accordion__summary-action:focus {
  color: var(
    ...
    var(--sds-c-accordion-heading-text-color-hover, rgb(1, 68, 134))
  );
}
