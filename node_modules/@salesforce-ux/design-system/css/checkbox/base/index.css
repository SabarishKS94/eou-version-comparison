...
.slds-checkbox .slds-checkbox_faux {
  ...
  border-color: var(
    ...
    var(--sds-c-checkbox-color-border, var(--slds-g-color-border-base-4, rgb(201, 201, 201)))
  );
  background-color: var(
    --slds-c-checkbox-color-background,
    var(--sds-c-checkbox-color-background, var(--slds-g-color-neutral-base-100, rgb(255, 255, 255)))
  );
...
.slds-checkbox [type="checkbox"]:checked + .slds-checkbox__label .slds-checkbox_faux:after {
  ...
  border-bottom: 2px solid
    var(
      ...
      var(--sds-c-checkbox-mark-color-foreground, var(--slds-s-mark-color-foreground-checked, rgb(1, 118, 211)))
    );
  /*! @noflip */
