...
.slds-textarea {
  ...
  background-color: var(
    ...
    var(--sds-c-textarea-color-background, var(--slds-g-color-neutral-base-100, rgb(255, 255, 255)))
  );
  color: var(--slds-c-textarea-text-color, var(--sds-c-textarea-text-color));
  border: 1px solid
    var(
      --slds-c-textarea-color-border,
      var(--sds-c-textarea-color-border, var(--slds-g-color-border-base-4, rgb(201, 201, 201)))
    );
...
.slds-textarea:active {
  ...
  background-color: var(
    ...
    var(--sds-c-textarea-color-background-focus, var(--slds-g-color-neutral-base-100, rgb(255, 255, 255)))
  );
  border-color: var(
    --slds-c-textarea-color-border-focus,
    var(
      --sds-c-textarea-color-border-focus,
      var(--slds-s-input-color-border-focus, var(--slds-g-color-brand-base-60, rgb(27, 150, 255)))
    )
  );
...
.slds-textarea:focus {
  border-color: var(--slds-s-input-color-border-focus, var(--slds-g-color-border-base-4, rgb(201, 201, 201)));
...
.slds-has-error .slds-textarea {
  ...
  --slds-c-textarea-color-background: var(--slds-g-color-neutral-base-100, rgb(255, 255, 255));
  /*! @css-var-fallback border-color */
  --slds-c-textarea-color-border: var(--slds-g-color-error-base-40, rgb(234, 0, 30));
  /*! @css-var-fallback box-shadow */
  --slds-c-textarea-shadow: var(--slds-g-color-error-base-40, rgb(234, 0, 30)) 0 0 0 1px inset;
...
.slds-has-error .slds-textarea:active {
  ...
  /*! @css-var-fallback box-shadow */
  --slds-c-textarea-shadow-focus: var(--slds-g-color-error-base-40, rgb(234, 0, 30)) 0 0 0 1px inset, 0 0 3px #0176d3;
}
.slds-has-error .slds-textarea:focus {
  /*! @css-var-fallback box-shadow */
  --slds-c-textarea-shadow-focus: var(--slds-g-color-error-base-40, rgb(234, 0, 30)) 0 0 0 1px inset,
