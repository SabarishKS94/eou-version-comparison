...
.slds-avatar {
  ...
  color: var(
    ...
    var(--sds-c-avatar-text-color, var(--slds-g-color-neutral-base-100, rgb(255, 255, 255)))
  );
}
.slds-avatar:hover,
...
.slds-avatar__initials:hover {
  color: var(
    ...
    var(--sds-c-avatar-initials-text-color-hover, var(--slds-g-color-neutral-base-100, rgb(255, 255, 255)))
  );
  cursor: default;
}
.slds-avatar__initials_inverse {
  ...
  --slds-c-avatar-initials-text-color: var(
    ...
    var(--slds-c-avatar-initials-inverse-text-color, var(--slds-g-color-neutral-base-30, rgb(68, 68, 68)))
  );
...
.slds-avatar__initials_inverse:hover {
  ...
  --slds-c-avatar-initials-text-color-hover: var(
    --slds-c-avatar-inverse-text-color,
    var(--slds-c-avatar-initials-inverse-text-color-hover, var(--slds-g-color-neutral-base-30, rgb(68, 68, 68)))
  );
}
