...
.slds-select {
  ...
  border: 1px solid
    var(
      ...
      var(--sds-c-select-color-border, var(--slds-g-color-border-base-4, rgb(201, 201, 201)))
    );
  border-radius: var(--slds-c-select-radius-border, var(--sds-c-select-radius-border, 0.25rem));
  background-color: var(
    --slds-c-select-color-background,
    var(--sds-c-select-color-background, var(--slds-g-color-neutral-base-100, rgb(255, 255, 255)))
  );
...
.slds-select:active {
  ...
  border-color: var(
    ...
    var(--sds-c-select-color-border-focus, var(--slds-g-color-brand-base-60, rgb(27, 150, 255)))
  );
  background-color: var(
    --slds-c-select-color-background-focus,
    var(--sds-c-select-color-background-focus, var(--slds-g-color-neutral-base-100, rgb(255, 255, 255)))
  );
...
.slds-has-error .slds-select {
  ...
  -webkit-box-shadow: var(--slds-g-color-error-base-40, rgb(234, 0, 30)) 0 0 0 1px inset;
  box-shadow: var(--slds-g-color-error-base-40, rgb(234, 0, 30)) 0 0 0 1px inset;
  background-clip: padding-box;
}
.slds-has-error .slds-select:active {
  -webkit-box-shadow: var(--slds-g-color-error-base-40, rgb(234, 0, 30)) 0 0 0 1px inset, 0 0 3px #0176d3;
  box-shadow: var(--slds-g-color-error-base-40, rgb(234, 0, 30)) 0 0 0 1px inset, 0 0 3px #0176d3;
}
