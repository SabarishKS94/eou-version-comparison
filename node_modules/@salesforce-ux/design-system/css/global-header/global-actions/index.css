...
.slds-global-actions__avatar {
  -webkit-box-shadow: rgb(129, 129, 129) 0 0 0 0;
  box-shadow: rgb(129, 129, 129) 0 0 0 0;
  border-radius: 50%;
  border: 0;
  margin-left: 0.5rem;
...
.slds-global-actions__avatar:hover {
  -webkit-box-shadow: rgb(129, 129, 129) 0 0 0 2px;
  box-shadow: rgb(129, 129, 129) 0 0 0 2px;
}
