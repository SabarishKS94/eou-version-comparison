...
.slds-notify_alert {
  ...
  color: var(
    ...
    var(--sds-c-alert-text-color, var(--slds-g-color-neutral-base-100, rgb(255, 255, 255)))
  );
  font-weight: var(--slds-c-alert-font-weight, var(--sds-c-alert-font-weight));
  text-align: center;
  background-color: var(
    --slds-c-alert-color-background,
    var(--sds-c-alert-color-background, var(--slds-g-color-neutral-base-50, rgb(116, 116, 116)))
  );
...
.slds-alert_warning {
  ...
  --slds-c-alert-color-background: var(--slds-g-color-warning-base-60, rgb(254, 147, 57));
...
.slds-alert_error {
  /*! @css-var-fallback background-color */
  --slds-c-alert-color-background: var(--slds-g-color-error-base-40, rgb(234, 0, 30));
}
.slds-alert_offline {
  /*! @css-var-fallback background-color */
  --slds-c-alert-color-background: var(--slds-g-color-neutral-base-30, rgb(68, 68, 68));
}
.slds-notify__close {
  position: absolute;
  top: 50%;
