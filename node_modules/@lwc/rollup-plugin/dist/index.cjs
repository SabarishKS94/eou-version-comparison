...
function parseDescriptorFromFilePath(id) {
    ...
    const params = new node_url.URLSearchParams(query);
...
function lwc(pluginOptions = {}) {
    ...
    const { targetSSR, ssrMode, stylesheetConfig, sourcemap = false, preserveHtmlComments, dynamicImports, experimentalDynamicDirective, enableDynamicComponents, enableSyntheticElementInternals, enableLwcOn, enableLightningWebSecurityTransforms, 
    // TODO [#3370]: remove experimental template expression flag
    experimentalComplexExpressions, disableSyntheticShadowSupport, apiVersion, defaultModules = DEFAULT_MODULES, componentFeatureFlagModulePath, enablePrivateMethods, } = pluginOptions;
    return {
        name: PLUGIN_NAME,
