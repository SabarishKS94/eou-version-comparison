export declare const ElementDescriptors: {
    ...
    classList: TypedPropertyDescriptor<DOMTokenList>;
    ...
    part: TypedPropertyDescriptor<DOMTokenList>;
    ...
    matches: TypedPropertyDescriptor<{
    ...
    textContent: TypedPropertyDescriptor<string>;
    ...
    ariaActiveDescendantElement: TypedPropertyDescriptor<Element | null>;
    ...
    ariaControlsElements: TypedPropertyDescriptor<readonly Element[] | null>;
    ariaCurrent: TypedPropertyDescriptor<string | null>;
    ariaDescribedByElements: TypedPropertyDescriptor<readonly Element[] | null>;
    ariaDescription: TypedPropertyDescriptor<string | null>;
    ariaDetailsElements: TypedPropertyDescriptor<readonly Element[] | null>;
    ariaDisabled: TypedPropertyDescriptor<string | null>;
    ariaErrorMessageElements: TypedPropertyDescriptor<readonly Element[] | null>;
    ariaExpanded: TypedPropertyDescriptor<string | null>;
    ariaFlowToElements: TypedPropertyDescriptor<readonly Element[] | null>;
    ...
    ariaLabelledByElements: TypedPropertyDescriptor<readonly Element[] | null>;
    ...
    ariaOwnsElements: TypedPropertyDescriptor<readonly Element[] | null>;
    ...
    moveBefore: TypedPropertyDescriptor<(node: Node, child: Node | null) => void>;
