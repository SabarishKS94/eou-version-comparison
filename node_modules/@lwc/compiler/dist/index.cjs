...
function scriptTransform(code, filename, options) {
    const { isExplicitImport, enableSyntheticElementInternals, dynamicImports, outputConfig: { sourcemap }, enableLightningWebSecurityTransforms, enablePrivateMethods, namespace, name, instrumentation, apiVersion, experimentalErrorRecoveryMode, componentFeatureFlagModulePath, } = options;
    ...
    const plugins = [
        ...(enablePrivateMethods ? [lwcClassTransformPlugin.LwcPrivateMethodTransform] : []),
        [lwcClassTransformPlugin, lwcBabelPluginOptions],
        [babelClassPropertiesPlugin, { loose: true }],
        ...(enablePrivateMethods ? [lwcClassTransformPlugin.LwcReversePrivateMethodTransform] : []),
    ];
