<template>
    ...
    <template if:true={isTypeCheckbox}>
        <lightning-primitive-input-checkbox
            ...
            checked={checked}
            disabled={disabled}
            exportparts="required, indicator, label"
            field-level-help={fieldLevelHelp}
            help-message={_helpMessage}
            helptext-alternative-text={helptextAlternativeText}
            label={label}
    ...
    <template if:true={isTypeDesktopDate}>
        <lightning-datepicker
            ...
            exportparts="label: label-datepicker, button-icon: button-icon-datepicker"
        >
        </lightning-datepicker>
    </template>
    ...
    <template if:true={isTypeDesktopTime}>
        <lightning-timepicker
            ...
            time-step-minutes={timeStepMinutes}
            placeholder={placeholder}
            onchange={handleChange}
            onblur={handleBlur}
            onfocus={handleFocus}
    ...
    <template if:true={isTypeDesktopDateTime}>
        <lightning-datetimepicker
            ...
            date-aria-error-message={dateAriaErrorMessage}
            aria-disabled={ariaDisabled}
            date-style={dateStyle}
            time-style={timeStyle}
            time-step-minutes={timeStepMinutes}
            ...
            time-aria-error-message={timeAriaErrorMessage}
            max={max}
            min={min}
            timezone={timezone}
            label={label}
    ...
    <template if:true={shouldShowHelpMessage}>
        <div
            id="help-message"
            class={computedHelpMessageClass}
            data-help-message
            part="help-text"
            role="status"
        >
