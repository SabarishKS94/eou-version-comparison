...
export default class ButtonOnclick extends LightningElement {
    ...
    handleToggleClick() {
        const contentBlockClasslist = this.template.querySelector('.lgc-id_content-toggle').classList;
    ...
    getRandomGreekLetter() {
        ...
        const textarea = new DOMParser().parseFromString(`<textarea>${letter} [ &${letter}; ]</textarea>`, 'text/html').body.firstChild;
