...
export function rgbToHsl(rgb) {
    ...
    if (maxColor !== minColor) {
        ...
        if (r1 === maxColor) {
            const x = g1 - b1, y = maxColor - minColor;
            H = x / y;
        }
        else if (g1 === maxColor) {
            const x = b1 - r1, y = maxColor - minColor, z = x / y;
            H = 2.0 + z;
        }
        else {
            const x = r1 - g1, y = maxColor - minColor, z = x / y;
            H = 4.0 + z;
        }
    }
    L *= 100;
...
export function rgbToPosition(rgb, canvas) {
    ...
    const saturation = hsv.saturation / 100, brightness = hsv.brightness / 100;
