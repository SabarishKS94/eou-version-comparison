...
import { fullHexValue, hexToRgb, rgbToHex, rgbToHsl, rgbToPosition, } from './colorUtil';
...
export default class LightningColorPickerCustom extends LightningShadowBaseClass {
    ...
    get useButtonNotAnchor() {
        return features.colorPickerButtonNotAnchorTag;
    }
    get thumbnailStyle() {
    ...
    updateSelectedColor(selectedColor) {
        ...
        this.dispatchEvent(new CustomEvent('updateselectedcolor', {
            bubbles: true,
            composed: true,
            cancelable: true,
