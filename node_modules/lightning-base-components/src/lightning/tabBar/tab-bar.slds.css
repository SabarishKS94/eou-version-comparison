...
:host([data-render-mode="shadow"]) [part='tab-bar'] {
  ...
  /* Sizing */
  /* stylelint-disable sds-stylelint-plugin/styling-hooks-pattern */
  --slds-c-tabs-item-sizing-height: var(
    --slds-c-tabbar-standard-sizing-height,
    var(--_slds-c-tabbar-standard-sizing-height)
  );
  /* stylelint-enable sds-stylelint-plugin/styling-hooks-pattern */
  ...
  /* Text */
  /* stylelint-disable sds-stylelint-plugin/styling-hooks-pattern */
  --slds-c-tabs-item-line-height: var(
    --slds-c-tabbar-standard-font-lineheight,
    var(--_slds-c-tabbar-standard-font-lineheight)
  );
  /* stylelint-enable sds-stylelint-plugin/styling-hooks-pattern */
}
...
:host([data-render-mode="shadow"]) [role='tab']:hover,:host([data-render-mode="shadow"]) 
[role='tab']:focus {
...
:host([data-render-mode="shadow"]) [part~='tab-overflow'] {
  ...
  --sds-c-button-spacing-inlinestart: var(--slds-g-spacing-4, 1rem);
  --sds-c-button-spacing-inlineend: var(--slds-g-spacing-4, 1rem);
...
:host([data-render-mode="shadow"][variant='standard']) [part='tab-bar'] {
  border-block-end-width: var(--slds-c-tabbar-standard-sizing-border, var(--slds-g-sizing-border-1, 1px));
  border-block-end-style: solid;
  border-block-end-color: var(
    --slds-c-tabbar-standard-color-border,
    var(--slds-g-color-border-base-4, var(--slds-g-color-border-1, var(--slds-g-color-neutral-base-80)))
  );
}
/* STANDARD TAB HEADER STYLING */
:host([data-render-mode="shadow"][variant='standard']) [part~='tab-item'] {
  color: var(--slds-c-tabbar-standard-text-color, var(--slds-g-color-on-surface-2, #2e2e2e));
  padding-block-start: var(
    --slds-c-tabbar-standard-spacing-blockstart,
    var(--slds-c-tabbar-standard-spacing-block, 0)
  );
  padding-inline-start: var(
    --slds-c-tabbar-standard-spacing-inlinestart,
    var(--slds-c-tabbar-standard-spacing-inline, var(--slds-g-spacing-3, 0.75rem))
  );
  padding-inline-end: var(
    --slds-c-tabbar-standard-spacing-inlineend,
    var(--slds-c-tabbar-standard-spacing-inline, var(--slds-g-spacing-3, 0.75rem))
  );
  padding-block-end: var(
    --slds-c-tabbar-standard-spacing-blockend,
    var(--slds-c-tabbar-standard-spacing-block, 0)
  );
  margin-block-end: calc(var(--slds-c-tabbar-standard-sizing-border, var(--slds-g-sizing-border-1, 1px)) * -1);
}
:host([data-render-mode="shadow"][variant='standard']) [part~='tab-item'].slds-is-active,:host([data-render-mode="shadow"][variant='standard']) [part~='tab-item'].slds-is-active:hover {
  --slds-c-tabbar-standard-text-color: var(
    --slds-c-tabbar-standard-text-color-active,
    var(--slds-g-color-on-surface-3, #181818)
  );
}
:host([data-render-mode="shadow"][variant='standard']) [part~='tab-item']:hover {
  color: var(
    --slds-c-tabbar-standard-text-color-hover,
    var(--slds-c-tabbar-standard-text-color, var(--slds-g-color-on-surface-2, #2e2e2e))
  );
}
...
:host([data-render-mode="shadow"][variant='standard']) [part~='tab-item'].slds-is-active::after {
  background-color: var(--slds-c-tabbar-standard-color-border-active, var(--slds-g-color-accent-1, var(--lwc-brandPrimary, var(--slds-g-color-brand-base-60))));
  height: calc(var(--slds-c-tabbar-standard-sizing-border, var(--slds-g-sizing-border-1, 1px)) + 2px);
}
...
:host([data-render-mode="shadow"][variant='standard']) [part~='tab-item']:hover::after,:host([data-render-mode="shadow"][variant='standard']) [part~='tab-item'].slds-is-active:hover::after {
  height: calc(var(--slds-c-tabbar-standard-sizing-border, var(--slds-g-sizing-border-1, 1px)) + 1px);
  background-color: var(--slds-c-tabbar-standard-color-border-hover, var(--slds-g-color-accent-1, var(--lwc-brandPrimary, var(--slds-g-color-brand-base-60))));
}
...
:host([data-render-mode="shadow"][variant='standard']) [part~='tab-overflow'] {
  ...
  --slds-c-button-neutral-text-color: var(
    --slds-c-tabbar-standard-text-color,
    var(--slds-g-color-on-surface-2, #2e2e2e)
  );
  ...
  --slds-c-button-neutral-text-color-focus: var(
    --slds-c-tabbar-standard-text-color-focus,
    var(--slds-g-color-on-surface-2, #2e2e2e)
  );
...
:host([data-render-mode="shadow"][variant='scoped']) [part='tab-bar'] {
  background-color: var(--slds-c-tabbar-scoped-color-background, var(--slds-g-color-surface-container-2, #f3f3f3));
  border: var(--slds-g-sizing-border-1, 1px) solid
    var(--slds-c-tabbar-scoped-color-border, var(--slds-g-color-border-base-4, var(--slds-g-color-border-1, var(--slds-g-color-neutral-base-80))));
  border-end-end-radius: 0;
  border-end-start-radius: 0;
  border-start-end-radius: var(--slds-c-tabbar-scoped-radius-border, var(--slds-g-radius-border-2, 0.25rem));
  border-start-start-radius: var(--slds-c-tabbar-scoped-radius-border, var(--slds-g-radius-border-2, 0.25rem));
}
...
:host([data-render-mode="shadow"][variant='scoped']) [part~='tab-item'] {
  margin-block-end: calc(var(--slds-g-sizing-border-1, 1px) * -1);
  color: var(--slds-c-tabbar-scoped-text-color, var(--slds-g-color-on-surface-2, #2e2e2e));
}
:host([data-render-mode="shadow"][variant='scoped']) [part~='tab-item'].slds-is-active {
  --slds-c-tabbar-scoped-text-color: var(
    --slds-c-tabbar-scoped-text-color-active,
    var(--slds-g-color-on-surface-3, #181818)
  );
}
/* Ensures that borders for tabs overlap */
:host([data-render-mode="shadow"][variant='scoped']) [part~='tab-item'] + [part~='tab-item'] {
  margin-inline-start: calc(var(--slds-g-sizing-border-1, 1px) * -1);
}
...
:host([data-render-mode="shadow"][variant='scoped']) [role='tab'] {
  ...
  /* stylelint-enable sds-stylelint-plugin/styling-hooks-pattern */
  padding-block-start: var(
    --slds-c-tabbar-scoped-spacing-blockstart,
    var(--slds-c-tabbar-scoped-spacing-block, 0)
  );
  padding-inline-start: var(
    --slds-c-tabbar-scoped-spacing-inlinestart,
    var(--slds-c-tabbar-scoped-spacing-inline, var(--slds-g-spacing-4, 1rem))
  );
  padding-inline-end: var(
    --slds-c-tabbar-scoped-spacing-inlineend,
    var(--slds-c-tabbar-scoped-spacing-inline, var(--slds-g-spacing-4, 1rem))
  );
  padding-block-end: var(
    --slds-c-tabbar-scoped-spacing-blockend,
    var(--slds-c-tabbar-scoped-spacing-block, 0)
  );
  color: currentcolor;
  background-clip: padding-box;
  border: 0;
  border-inline-start: var(--slds-g-sizing-border-1, 1px) solid transparent;
  border-inline-end: var(--slds-g-sizing-border-1, 1px) solid transparent;
  border-radius: 0;
  display: block;
}
...
:host([data-render-mode="shadow"][variant='scoped']) [role='tab']:hover {
  border-color: var(
    --slds-c-tabbar-scoped-color-border-hover,
    var(--slds-g-color-border-base-4, var(--slds-g-color-border-1, var(--slds-g-color-neutral-base-80)))
  );
...
:host([data-render-mode="shadow"][variant='scoped']) .slds-is-active [role='tab'] {
  background-color: var(
    --slds-c-tabbar-scoped-color-background-active,
    var(--slds-g-color-surface-container-1, #ffffff)
  );
  border-color: var(
    --slds-c-tabbar-scoped-color-border-active,
    var(--slds-g-color-border-base-4, var(--slds-g-color-border-1, var(--slds-g-color-neutral-base-80)))
  );
}
...
:host([data-render-mode="shadow"][variant='scoped']) [part~='tab-overflow'] {
  ...
  line-height: var(--slds-c-tabbar-scoped-sizing-height, var(--_slds-c-tabbar-scoped-sizing-height));
  /* stylelint-enable sds-stylelint-plugin/styling-hooks-pattern */
  --slds-c-buttonicon-spacing-inline: var(--slds-g-spacing-4, 1rem);

  /* Text Color */
  --slds-c-button-neutral-text-color: var(
    --slds-c-tabbar-scoped-text-color,
    var(--slds-g-color-on-surface-2, #2e2e2e)
  );
  --slds-c-button-neutral-text-color-hover: var(
    --slds-c-tabbar-scoped-text-color,
...
:host([data-render-mode="shadow"][variant='vertical']) [part='tab-bar'] {
  background: var(--slds-c-tabbar-vertical-color-background, var(--slds-g-color-surface-container-2, #f3f3f3));
  border-inline-end: var(--slds-g-sizing-border-1, 1px) solid
    var(
      --slds-c-tabbar-vertical-color-border,
      var(--slds-g-color-border-base-1, var(--slds-g-color-border-1, var(--slds-g-color-neutral-base-80)))
    );
  /* stylelint-disable sds-stylelint-plugin/styling-hooks-pattern */
...
:host([data-render-mode="shadow"][variant='vertical']) [part='tab-item'] {
  ...
  align-items: center;
  overflow: hidden;
  border-block-end: var(--slds-g-sizing-border-1, 1px) solid
    var(
      --slds-c-tabbar-vertical-color-border,
      var(--slds-g-color-border-base-1, var(--slds-g-color-border-1, var(--slds-g-color-neutral-base-80)))
    );
...
:host([data-render-mode="shadow"][variant='vertical']) [part='tab-item'].slds-is-active {
  margin-inline-end: calc(var(--slds-g-sizing-border-1, 1px) * -1);
  background: var(--slds-c-tabbar-vertical-color-background-active, var(--slds-g-color-surface-container-1, #ffffff));
  color: var(--slds-c-tabbar-vertical-text-color-active, var(--slds-g-color-accent-2, var(--lwc-brandPrimaryActive, var(--slds-g-color-brand-base-50))));
}
...
:host([data-render-mode="shadow"][variant='vertical']) [role='tab'] {
  ...
  min-width: 0;
  padding-block-start: var(
    --slds-c-tabbar-vertical-spacing-blockstart,
    var(--slds-c-tabbar-vertical-spacing-block, var(--slds-g-spacing-3, 0.75rem))
  );
  padding-inline-start: var(
    --slds-c-tabbar-vertical-spacing-inlinestart,
    var(--slds-c-tabbar-vertical-spacing-inline, var(--slds-g-spacing-3, 0.75rem))
  );
  padding-inline-end: var(
    --slds-c-tabbar-vertical-spacing-inlineend,
    var(--slds-c-tabbar-vertical-spacing-inline, var(--slds-g-spacing-3, 0.75rem))
  );
  padding-block-end: var(
    --slds-c-tabbar-vertical-spacing-blockend,
    var(--slds-c-tabbar-vertical-spacing-block, var(--slds-g-spacing-3, 0.75rem))
  );
...
:host([data-render-mode="shadow"][variant='vertical']) [role='tab']:hover {
  background: var(--slds-c-tabbar-vertical-color-background-hover, var(--slds-g-color-surface-container-3, #e5e5e5));
  color: var(--slds-c-tabbar-vertical-text-color-hover, var(--slds-g-color-on-surface-3, #181818));
}
...
:host([data-render-mode="shadow"][variant='vertical']) .slds-is-active [role='tab']:hover {
  ...
  /* stylelint-disable-next-line sds-stylelint-plugin/styling-hooks-pattern */
  color: var(
    --slds-c-tabbar-vertical-text-color-hover,
    var(--slds-s-navigation-color-hover, var(--slds-g-color-neutral-base-20, #2e2e2e))
  );
}
:host([data-render-mode="shadow"][variant='scoped']) .slds-is-active [role='tab']:focus,:host([data-render-mode="shadow"][variant='vertical']) .slds-is-active [role='tab']:focus {
  box-shadow: var(--slds-g-shadow-6, 0 -1px 2px 0 #18181803, 0 3px 2px -2px #1818180a, 0 7px 5px -2px #1818180a, 0 12px 10px -2px #18181808, 0 22px 18px -2px #18181808, 0 41px 33px -2px #18181808, 0 100px 80px -2px #18181810, 0 0 3px #0176d3);
}
