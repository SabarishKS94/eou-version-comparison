...
:host([data-render-mode="shadow"]) .slds-modal__container {
  ...
  margin: 0 var(--slds-g-spacing-6, 2rem);
  height: 100%;
  padding: var(--slds-g-spacing-8, 3rem) 0 var(--slds-g-spacing-12, 5rem) 0;
  border-radius: var(--slds-g-spacing-1, 0.25rem);
}
...
@media (width <= 30em) {
  ...
  :host([data-render-mode="shadow"]) .slds-modal_full .slds-modal__container {
    ...
    min-width: 0;
    margin: 0;
    padding: var(--slds-g-spacing-4, 1rem) 0 0 0;
    background-color: var(--slds-c-modalbase-color-background, var(--slds-g-color-surface-1, #ffffff));
    border-radius: 0;
  ...
  :host([data-render-mode="shadow"]) .slds-modal_full .slds-modal__close {
    grid-area: close;
    inset-inline-end: var(--slds-g-spacing-4, 1rem);
    ...
    /**
       ...
       */
    --slds-c-button-color-background: var(--slds-g-color-surface-container-1, #ffffff, white);
    --slds-c-button-color-background-active: var(--slds-g-color-surface-container-1, #ffffff, white);
  ...
  .slds-modal_full .slds-modal__close:focus {
    color: var(--slds-g-color-accent-3, #0b5cab);
  }
