...
:host([data-render-mode="shadow"].slds-tabs_default__content) {
  ...
  position: relative;
  padding-block-start: var(--slds-c-tab-panel-spacing-blockstart, var(--slds-g-spacing-3, 0.75rem));
  padding-inline-end: var(--slds-c-tab-panel-spacing-inlineend, 0);
  padding-block-end: var(--slds-c-tab-panel-spacing-blockend, var(--slds-g-spacing-3, 0.75rem));
...
:host([data-render-mode="shadow"].slds-tabs_scoped__content) {
  ...
  border: var(--slds-g-sizing-border-1, 1px) solid var(--slds-g-color-border-base-4, var(--slds-g-color-border-1, var(--slds-g-color-neutral-base-80)));
  border-block-start: 0;
  border-start-start-radius: 0;
  border-start-end-radius: 0;
  border-end-end-radius: var(--slds-g-spacing-1, 0.25rem);
  border-end-start-radius: var(--slds-g-spacing-1, 0.25rem);
...
:host([data-render-mode="shadow"].slds-vertical-tabs__content) {
  flex: 1;
  padding: var(--slds-g-spacing-4, 1rem);
  background: var(--slds-g-color-neutral-base-100, #ffffff, var(--slds-g-color-surface-container-1, #ffffff));
}
