<template>
    <lightning-modal-header label={i18n.modalTitle}></lightning-modal-header>
    ...
    <div class="slds-assistive-text" role="status">{assistiveText}</div>
</template>
