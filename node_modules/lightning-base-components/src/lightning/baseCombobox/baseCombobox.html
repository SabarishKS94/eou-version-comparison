        ...
        <div class={computedDropdownTriggerClass}
            ...
            <div class={computedFormElementClass} role="none">
                <template if:true={hasInputPill}>
                    <lightning-icon id="input-pill-search-icon" data-input-pill-search-icon icon-name={inputPill.iconName} alternative-text={inputPill.iconAlternativeText} size="x-small" class="slds-icon_container slds-combobox__input-entity-icon"></lightning-icon>
                </template>
                <!--
                ...
                <template if:true={isUserInputDisabled}>
                    <button id="combobox-button"
                        ...
                        onblur={handleBlur}
                        part="input-button">
                        <span class="slds-truncate" part="input-button-value">
                ...
                <template if:true={isCloseVisible}>
                    <div class="slds-input__icon-group slds-input__icon-group_right">
                        <button onclick={handlePillRemove} type="button"
                            ...
                            <span class="slds-assistive-text">{clearSelectionText}</span>
                        </button>
                    </div>
                </template>
                <template if:false={hasInputPill}>
                    <div class="slds-input__icon-group slds-input__icon-group_right">
                        <template if:true={showInputActivityIndicator}>
                            <div role="status" class="slds-spinner slds-spinner_brand slds-spinner_x-small slds-input__spinner" part="spinner">
                                <span class="slds-assistive-text">{i18n.loadingText}</span>
                                <div part="dot-a" class="slds-spinner__dot-a"></div>
                                <div part="dot-b" class="slds-spinner__dot-b"></div>
                            </div>
                        </template>
