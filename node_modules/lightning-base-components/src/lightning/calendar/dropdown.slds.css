...
.slds-nubbin_top::after {
  width: var(--slds-g-spacing-4, 1rem);
  ...
  /* Position: Top */
  left: 50%;
  top: calc((var(--slds-g-spacing-4, 1rem) * 0.5) * -1);
  margin-left: calc((var(--slds-g-spacing-4, 1rem) * 0.5) * -1);
  z-index: -1;
}
...
.slds-nubbin_top-left-corner::after {
  ...
  /* Position: Top */
  left: var(--slds-g-spacing-5, 1.5rem);
  top: calc((var(--slds-g-spacing-4, 1rem) * 0.5) * -1);
  margin-left: calc((var(--slds-g-spacing-4, 1rem) * 0.5) * -1);
  z-index: -1;
}
...
.slds-nubbin_top-right-corner::after {
  ...
  margin-left: calc((var(--slds-g-spacing-4, 1rem) * 0.5) * -1);
  left: auto;
  right: var(--slds-g-spacing-5, 1.5rem);
  top: calc((var(--slds-g-spacing-4, 1rem) * 0.5) * -1);
  margin-right: calc((var(--slds-g-spacing-4, 1rem) * 0.5) * -1);
  z-index: -1;
}
...
.slds-nubbin_bottom::after {
  ...
  /* Position: Bottom */
  left: 50%;
  bottom: calc((var(--slds-g-spacing-4, 1rem) * 0.5) * -1);
  margin-left: calc((var(--slds-g-spacing-4, 1rem) * 0.5) * -1);
  z-index: -1;
}
...
.slds-nubbin_bottom-left-corner::after {
  ...
  left: var(--slds-g-spacing-5, 1.5rem);
  top: 100%;
  margin-top: calc((var(--slds-g-spacing-4, 1rem) * 0.5) * -1);
  z-index: -1;
}
...
.slds-nubbin_bottom-right-corner::after {
  ...
  /* Position: Bottom */
  inset: 100% auto calc((var(--slds-g-spacing-4, 1rem) * 0.5) * -1) var(--slds-g-spacing-5, 1.5rem);
  margin-top: calc((var(--slds-g-spacing-4, 1rem) * 0.5) * -1);
  margin-right: calc((var(--slds-g-spacing-4, 1rem) * 0.5) * -1);
  margin-left: calc((var(--slds-g-spacing-4, 1rem) * 0.5) * -1);
  z-index: -1;
...
.slds-nubbin_left::after {
  ...
  /* Position: Left */
  top: 50%;
  left: calc((var(--slds-g-spacing-4, 1rem) * 0.5) * -1);
  margin-top: calc((var(--slds-g-spacing-4, 1rem) * 0.5) * -1);
  z-index: -1;
}
...
.slds-nubbin_left-top-corner::after {
  ...
  left: calc((var(--slds-g-spacing-4, 1rem) * 0.5) * -1);
  margin-top: calc((var(--slds-g-spacing-4, 1rem) * 0.5) * -1);
  top: var(--slds-g-spacing-5, 1.5rem);
  z-index: -1;
}
...
.slds-nubbin_left-bottom-corner::after {
  ...
  margin-top: calc((var(--slds-g-spacing-4, 1rem) * 0.5) * -1);
  top: auto;
  bottom: var(--slds-g-spacing-4, 1rem);
  z-index: -1;
}
...
.slds-nubbin_right::after {
  ...
  /* Position: Right */
  top: 50%;
  right: calc((var(--slds-g-spacing-4, 1rem) * 0.5) * -1);
  margin-top: calc((var(--slds-g-spacing-4, 1rem) * 0.5) * -1);
  z-index: -1;
}
...
:host([data-render-mode="shadow"]) .slds-nubbin_top-left-corner {
  border-radius: var(--slds-g-sizing-border-2, 2px) var(--slds-g-sizing-border-4, 4px) var(--slds-g-sizing-border-4, 4px)
...
:host([data-render-mode="shadow"]) .slds-nubbin_bottom-left-corner {
  border-radius: var(--slds-g-sizing-border-4, 4px) var(--slds-g-sizing-border-4, 4px) var(--slds-g-sizing-border-4, 4px)
...
:host([data-render-mode="shadow"]) .slds-nubbin_top-right-corner {
  border-radius: var(--slds-g-sizing-border-4, 4px) var(--slds-g-sizing-border-2, 2px) var(--slds-g-sizing-border-4, 4px)
    var(--slds-g-sizing-border-4, 4px);
}

:host([data-render-mode="shadow"]) .slds-nubbin_top-right-corner::before,:host([data-render-mode="shadow"]) 
.slds-nubbin_top-right-corner::after {
  right: var(--slds-g-spacing-3, 0.75rem);
}

:host([data-render-mode="shadow"]) .slds-nubbin_bottom-right-corner {
  border-radius: var(--slds-g-sizing-border-4, 4px) var(--slds-g-sizing-border-4, 4px) var(--slds-g-sizing-border-2, 2px)
    var(--slds-g-sizing-border-4, 4px);
}
...
.slds-nubbin_left-bottom-corner::after {
  bottom: var(--slds-g-spacing-1, 0.25rem);
}
...
:host([data-render-mode="shadow"]) [part~='dropdown'] {
  ...
  --_dropdown-size-medium: var(--slds-g-sizing-15, 20rem);
  --_dropdown-square-icon-small-boundary: var(--slds-g-sizing-7, 1.5rem);
  --_nubbin-size-default: var(--slds-g-sizing-5, 1rem);
  ...
  color: var(--slds-c-dropdown-color, var(--slds-g-color-on-surface-3, #181818));
  border-radius: var(--slds-g-radius-border-2, 0.25rem);
  border-width: var(--slds-g-sizing-border-1, 1px);
  border-color: var(--slds-g-color-border-1, var(--slds-g-color-neutral-base-80));
  ...
  font-size: var(--slds-c-dropdown-font-size, var(--slds-g-font-scale-neg-1, 0.75rem));
...
:host([data-render-mode="shadow"]) mark {
  font-weight: var(--slds-g-font-weight-bold, bold);
...
.slds-dropdown-trigger > [class*='slds-button_icon'] ~ .slds-dropdown_left[class*='slds-nubbin'] {
  left: calc(var(--slds-g-spacing-2, 0.5rem) * -1);
}
...
.slds-dropdown-trigger > [class*='slds-button_icon'] ~ .slds-dropdown_right[class*='slds-nubbin'] {
  right: calc(var(--slds-g-spacing-2, 0.5rem) * -1);
}
...
:host([data-render-mode="shadow"]) .slds-dropdown_small {
  min-width: var(--slds-g-sizing-14, 15rem);
}
...
:host([data-render-mode="shadow"]) .slds-dropdown_length-5 {
  max-height: calc(
    ((var(--slds-g-font-scale-neg-3, var(--slds-g-font-scale-neg-2)) * var(--slds-g-font-lineheight)) + var(--slds-g-spacing-4, 1rem)) * 5
  );
  overflow-y: auto;
}
...
:host([data-render-mode="shadow"]) .slds-dropdown_length-7 {
  max-height: calc(
    ((var(--slds-g-font-scale-neg-3, var(--slds-g-font-scale-neg-2)) * var(--slds-g-font-lineheight)) + var(--slds-g-spacing-4, 1rem)) * 7
  );
  overflow-y: auto;
}
...
:host([data-render-mode="shadow"]) .slds-dropdown_length-10 {
  max-height: calc(
    ((var(--slds-g-font-scale-neg-3, var(--slds-g-font-scale-neg-2)) * var(--slds-g-font-lineheight)) + var(--slds-g-spacing-4, 1rem)) * 10
  );
  overflow-y: auto;
}
...
:host([data-render-mode="shadow"]) .slds-dropdown_length-with-icon-5 {
  /* stylelint-disable sds-stylelint-plugin/styling-hooks-pattern */
  max-height: calc((var(--_dropdown-square-icon-small-boundary) + var(--slds-g-spacing-4, 1rem)) * 5);
  /* stylelint-enable sds-stylelint-plugin/styling-hooks-pattern */
  overflow-y: auto;
}
...
:host([data-render-mode="shadow"]) .slds-dropdown_length-with-icon-7 {
  /* stylelint-disable sds-stylelint-plugin/styling-hooks-pattern */
  max-height: calc((var(--_dropdown-square-icon-small-boundary) + var(--slds-g-spacing-4, 1rem)) * 7);
  /* stylelint-enable sds-stylelint-plugin/styling-hooks-pattern */
  overflow-y: auto;
}
...
:host([data-render-mode="shadow"]) .slds-dropdown_length-with-icon-10 {
  /* stylelint-disable sds-stylelint-plugin/styling-hooks-pattern */
  max-height: calc((var(--_dropdown-square-icon-small-boundary) + var(--slds-g-spacing-4, 1rem)) * 10);
  /* stylelint-enable sds-stylelint-plugin/styling-hooks-pattern */
  overflow-y: auto;
}
...
.slds-dropdown_inverse .slds-dropdown__item > a:focus {
  color: var(--slds-g-color-neutral-base-90, #e5e5e5);
  background-color: transparent;
}
...
:host([data-render-mode="shadow"]) .slds-dropdown_inverse .slds-dropdown__item > a[aria-disabled='true'] {
  color: var(--slds-g-color-palette-blue-20, #032d60);
  cursor: default;
}
...
:host([data-render-mode="shadow"]) .slds-dropdown_actions a {
  color: var(--slds-g-color-accent-2, var(--lwc-brandPrimaryActive, var(--slds-g-color-brand-base-50)));
}
...
:host([data-render-mode="shadow"]) .slds-has-submenu .slds-dropdown_submenu-right {
  left: 100%;
  margin-left: var(--slds-g-spacing-1, 0.25rem);
}
...
:host([data-render-mode="shadow"]) .slds-has-submenu .slds-dropdown_submenu-bottom {
  top: auto;
  bottom: 0;
  margin-bottom: calc(var(--slds-g-spacing-1, 0.25rem) * -1);
}
