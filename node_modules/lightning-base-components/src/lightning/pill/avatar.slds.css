...
:host([data-render-mode="shadow"]) [part='avatar'] {
  width: var(--slds-c-avatar-sizing, var(--slds-g-sizing-9, 2rem));
  height: var(--slds-c-avatar-sizing, var(--slds-g-sizing-9, 2rem));
  overflow: hidden;
  display: inline-block;
  vertical-align: middle;
  border-radius: var(--slds-c-avatar-radius-border, var(--slds-g-radius-border-2, 0.25rem));
  line-height: var(--slds-g-font-lineheight-1, 1);
  font-size: var(--slds-g-font-scale-neg-1, 0.75rem);
  color: var(--slds-c-avatar-text-color, var(--slds-g-color-on-accent-1, var(--slds-g-color-brand-base-100)));
}
...
:host([data-render-mode="shadow"][size='x-small']) [part='avatar'] {
  ...
  --slds-c-icon-sizing: var(--slds-g-sizing-6, 1.25rem);
}
...
:host([data-render-mode="shadow"][variant='circle']) [part='avatar'] {
  border-radius: calc(var(--slds-g-radius-border-circle, 100%) / 2);
}

:host([data-render-mode="shadow"].slds-avatar_empty) [part='avatar'] {
  border: var(--slds-g-sizing-border-1, 1px) dashed var(--slds-g-color-neutral-base-90, #e5e5e5);
}
...
:host([data-render-mode="shadow"]) .slds-avatar__initials:hover {
  color: var(--slds-c-avatar-initials-text-color-hover, var(--slds-g-color-neutral-base-100, #ffffff));
}
...
:host([data-render-mode="shadow"]) .slds-avatar__initials_inverse {
  --slds-c-avatar-text-color: var(--slds-c-avatar-inverse-text-color, var(--slds-g-color-neutral-base-30, #444444));
