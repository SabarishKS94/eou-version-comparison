...
:host([data-render-mode="shadow"]) {
  ...
  --slds-c-button-neutral-color-border-active: var(--slds-c-buttonstateful-color-border-active, transparent);
  ...
  --slds-c-button-neutral-shadow-focus: var(
    ...
    var(--slds-g-color-accent-2, var(--lwc-brandPrimaryActive, var(--slds-g-color-brand-base-50))) 0 0 3px
  );

  /* Pressed/Selected State */
  --sds-c-button-text-color-pressed: var(--slds-g-color-accent-2, var(--lwc-brandPrimaryActive, var(--slds-g-color-brand-base-50)));
...
:host([data-render-mode="shadow"]) .slds-button_stateful:hover {
  --sds-c-button-color-background-pressed: var(--slds-g-color-surface-container-2, #f3f3f3);
  --sds-c-button-text-color-pressed: var(--slds-s-button-color-hover);
  --sds-c-button-color-border-pressed: var(--slds-g-color-border-1, var(--slds-g-color-neutral-base-80));
}

:host([data-render-mode="shadow"]) .slds-is-selected-clicked {
  --sds-c-button-color-background-pressed: var(--slds-g-color-surface-container-1, #ffffff);
  --sds-c-button-text-color-pressed: var(--slds-g-color-accent-2, var(--lwc-brandPrimaryActive, var(--slds-g-color-brand-base-50)));
}

:host([data-render-mode="shadow"]) .slds-is-selected-clicked:focus {
  --sds-c-button-color-background-pressed: var(--slds-g-color-surface-container-2, #f3f3f3);
  --sds-c-button-text-color-pressed: var(--slds-g-color-accent-3, #0b5cab);
