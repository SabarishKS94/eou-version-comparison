...
const isInputButton = (element) => element.type === 'button' || element.type === 'submit';
const implementNativeArrowNavigation = (element) => (isInput(element) && !isInputButton(element)) || isTextarea(element);
const { setContext, assertContext } = privateContext;
export const baseNavigation = (superclass) => class extends superclass {
    constructor() {
        super();
        setContext(this);
    }
    ...
    connectedCallback() {
        ...
        this.setAttribute('tabindex', this.keyboardMode === 'ACTION' ? 0 : -1);
        this.addEventListener('keydown', this[handleArrowKeyDown].bind(this));
    ...
    [handleArrowLeft](event) {
        if (this.template.activeElement !== null) {
            ...
            console.warn('Error: Delegate focus with no focusable child element.');
        }
    }
