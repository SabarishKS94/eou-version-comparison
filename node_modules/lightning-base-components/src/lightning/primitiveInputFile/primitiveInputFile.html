<template>
        ...
        <div class="slds-file-selector slds-file-selector_files" ondrop={handleDropFiles} part="file-selector">
            <lightning-primitive-file-droppable-zone multiple={multiple} disabled={disabled}>
                <input type="file" id="input-file"
                    ...
                    disabled={disabled}
                    part="input">
                <label id="file-selector-label" data-file-selector-label for="input-file" class="slds-file-selector__body">
    ...
    <div id="help-message" data-name={name} class="slds-form-element__help" data-help-message part="help-text" role="status">
