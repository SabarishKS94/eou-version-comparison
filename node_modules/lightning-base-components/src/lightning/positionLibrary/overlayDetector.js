...
export const OVERLAY_TYPE = {
    ...
    PANEL: 'uiPanel',
    LIGHTNING_OVERLAY: 'overlay-surface',
...
export function isOverlay(element) {
    ...
    const isLightningOverlay = element.classList &&
        element.classList.contains(OVERLAY_TYPE.LIGHTNING_OVERLAY);
    if (isLightningOverlay) {
        return OVERLAY_TYPE.LIGHTNING_OVERLAY;
    }
...
function isInsideOverlay(element) {
    ...
    return isInsideOverlay(isShadowRoot(element.parentNode)
