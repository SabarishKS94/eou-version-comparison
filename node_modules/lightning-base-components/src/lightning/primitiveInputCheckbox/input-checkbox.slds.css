/*******************************************
* Imported dependency from @salesforce-ux/sds-components/src/sds/inputCheckbox/inputCheckbox.css
*******************************************/
*,
*::before,
*::after {
 ...
 * Focus state
 */
:host([data-render-mode="shadow"]) [part='checkbox']:has(:focus),:host([data-render-mode="shadow"]) 
...
:host([data-render-mode="shadow"]) [part='input-checkbox'] [part='label'] {
  color: var(--_slds-c-inputcheckbox-label-color, var(--slds-g-color-on-surface-2, #2e2e2e));
  margin-block-end: 0;
...
:host([data-render-mode="shadow"]) [part='indicator'] {
  ...
  width: 1rem;
  height: 1rem;
  border-radius: var(--_slds-c-inputcheckbox-radius-border, var(--slds-g-radius-border-1, 0.125rem));
  border: var(--_slds-c-inputcheckbox-sizing-border, var(--slds-g-sizing-border-1, 1px)) solid
    var(--_slds-c-inputcheckbox-color-border, var(--slds-g-color-border-2, var(--slds-g-color-neutral-base-50)));
  background-color: var(--_slds-c-inputcheckbox-color-background, var(--slds-g-color-surface-container-1, #ffffff));
...
:host([data-render-mode="shadow"][checked]) [part='indicator']::after {
  ...
  border-bottom: 2px solid
    var(--_slds-c-inputcheckbox-mark-color-foreground, var(--slds-g-color-border-accent-2, #0b5cab));
...
:host([data-render-mode="shadow"][disabled]) [part='indicator'] {
  --_slds-c-inputcheckbox-color-background: var(
    ...
    var(--slds-g-color-disabled-container-2, #c9c9c9)
  );
  --_slds-c-inputcheckbox-color-border: var(
    --_slds-c-inputcheckbox-color-border-disabled,
    var(--slds-g-color-border-disabled-1, #c9c9c9)
  );
  --_slds-c-inputcheckbox-mark-color-foreground: var(
    --_slds-c-inputcheckbox-mark-color-foreground-disabled,
    var(--slds-g-color-on-disabled-2, #939393)
  );
}
/**
     * Focused
...
:host(:not([disabled])) input:focus-within + .slds-checkbox__label [part='indicator'] {
  ...
  --_slds-c-inputcheckbox-color-border: var(
    ...
    var(--slds-g-color-accent-2, var(--lwc-brandPrimaryActive, var(--slds-g-color-brand-base-50)))
  );
  --_slds-c-inputcheckbox-shadow: var(
    --_slds-c-inputcheckbox-shadow-focus,
    0 0 3px var(--slds-g-color-accent-2, var(--lwc-brandPrimaryActive, var(--slds-g-color-brand-base-50)))
  );
}
/**
     * Invalid
...
:host([data-render-mode="shadow"][invalid]) [part='indicator'] {
  ...
  --_slds-c-inputcheckbox-color-border: var(
    ...
    var(--slds-g-color-border-error-1, #ba0517)
  );
  --_slds-c-inputcheckbox-mark-color-foreground: var(
    --_slds-c-inputcheckbox-mark-color-foreground-invalid,
    var(--slds-g-color-error-1, #ba0517)
  );
}
:host([data-render-mode="shadow"][invalid]) [part='help-text'] {
  color: var(--_slds-c-inputcheckbox-helptext-color-invalid, var(--slds-g-color-error-1, #ba0517));
}
/**
...
@media (width >= 48em) {
  ...
  :host([data-render-mode="shadow"][variant='label-inline']) [part='input-checkbox'] {
    ...
    padding-block: var(--slds-g-spacing-1, 0.25rem);
...
:host([data-render-mode="shadow"]) .slds-checkbox [type='checkbox']:indeterminate + .slds-checkbox__label .slds-checkbox_faux::after {
  content: '';
  display: block;
  position: absolute;
  top: 50%;
