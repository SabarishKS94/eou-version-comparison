    ...
    <div role="group" aria-labelledby="group-label" part="dual-listbox">
        ...
        <div class="slds-form-element__control">
            <div class="slds-dueling-list" onfocusin={handleFocus} onfocusout={handleBlur}>
                ...
                <div class="slds-assistive-text" id="keyboard-interaction">{computedA11yAriaLiveKbText}</div>
                <div class={computedLeftColumnClass}>
                    ...
                    <div class={computedListboxContainerClass} style={computedColumnStyle}>
                        <ul data-source-list id="source-list" aria-describedby="keyboard-interaction" aria-labelledby="source-list-label" aria-multiselectable="true"
                ...
                <div class="slds-dueling-list__column">
                    <lightning-button-icon icon-name="utility:right" variant="container" onclick={handleRightButtonClick} disabled={moveButtonRightDisabled}
                        title={addButtonLabel} alternative-text={addButtonLabel} tooltip={addButtonDescription}>
                    </lightning-button-icon>
                    <lightning-button-icon icon-name="utility:left" variant="container" onclick={handleLeftButtonClick} disabled={moveButtonLeftDisabled}
                ...
                <div class="slds-dueling-list__column slds-dueling-list__column_responsive">
                    ...
                    <div class={computedListboxContainerClass} style={computedColumnStyle}>
                        <ul data-selected-list id="selected-list" aria-describedby="keyboard-interaction" aria-labelledby="selected-list-label" aria-multiselectable="true"
                            class="slds-listbox slds-listbox_vertical" role="listbox" part="listbox" aria-disabled={ariaDisabled}>
                ...
                <template if:false={disableReordering}>
                    <div class="slds-dueling-list__column">
                        <lightning-button-icon icon-name="utility:up" variant="container" onclick={handleUpButtonClick} disabled={reorderButtonsDisabled} title={upButtonLabel}
                            alternative-text={upButtonLabel}>
                        </lightning-button-icon>
                        <lightning-button-icon icon-name="utility:down" variant="container" onclick={handleDownButtonClick} disabled={reorderButtonsDisabled} title={downButtonLabel}
