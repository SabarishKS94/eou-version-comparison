...
:host([data-render-mode="shadow"]) .slds-progress-ring {
  ...
  background: var(--slds-g-color-border-base-1, var(--slds-g-color-surface-container-3, #e5e5e5));
}
...
:host([data-render-mode="shadow"]) .slds-progress-ring__path {
  fill: var(--slds-g-color-success-1, #2e844a);
}
...
.slds-progress-ring_warning .slds-progress-ring__path {
  fill: var(--slds-g-color-warning-1, #fe9339);
}
/* variant = expired */
...
.slds-progress-ring_complete .slds-icon svg {
  fill: var(--slds-g-color-on-success-1, #ffffff);
}
...
:host([data-render-mode="shadow"]) .slds-progress-ring_complete .slds-progress-ring__content {
  background: var(--slds-g-color-success-container-2, #194e31);
}
/* size = large */
...
:host([data-render-mode="shadow"]) .slds-progress-ring_active-step .slds-progress-ring__path {
  fill: var(--slds-g-color-accent-1, var(--lwc-brandPrimary, var(--slds-g-color-brand-base-60)));
}
/* additional classes */
