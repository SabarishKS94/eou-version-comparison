/*******************************************
* Imported dependency from @salesforce-ux/sds-components/src/sds/inputText/inputText.css
*******************************************/
/**
 * Input container
 * ---
...
:host([data-render-mode="shadow"]) [part='input-text'] {
  ...
  --slds-c-icon-color-foreground: var(
    ...
    var(--slds-g-color-on-surface-1, #747474)
  );
  --slds-c-icon-sizing: var(--slds-c-inputtext-icon-sizing, 14px);
  --sds-c-inputtext-sizing-height: var(--slds-c-inputtext-sizing-height, var(--slds-g-sizing-9, 2rem));
  --sds-c-inputtext-color-background: var(
  ...
  --sds-c-inputtext-font-size: var(--slds-c-inputtext-font-size, var(--slds-g-font-size-base, 0.8125rem));
  --sds-c-inputtext-text-color-placeholder: var(
    --slds-c-inputtext-text-color-placeholder,
    var(--slds-g-color-on-surface-1, #747474)
  );
  --sds-c-inputtext-color-border: var(--slds-c-inputtext-color-border, var(--slds-g-color-border-2, var(--slds-g-color-neutral-base-50)));
  --sds-c-inputtext-sizing-border: var(--slds-c-inputtext-sizing-border);
  --sds-c-inputtext-radius-border: var(--slds-c-inputtext-radius-border, var(--slds-g-radius-border-2, 0.25rem));
...
[part='input-container'][type='range']:active {
  --sds-c-inputtext-color-border: var(--slds-g-color-border-accent-1, #0176d3);
  --sds-c-inputtext-shadow: 0 0 3px var(--slds-g-color-accent-2, var(--lwc-brandPrimaryActive, var(--slds-g-color-brand-base-50)));
  --sds-c-inputtext-color-background: var(--slds-g-color-surface-container-1, #ffffff);

  outline: 0;
  border-width: var(--sds-c-inputtext-sizing-border, var(--slds-g-sizing-border-1, 1px));
  border-color: var(--sds-c-inputtext-color-border, var(--slds-g-color-border-2, var(--slds-g-color-neutral-base-50)));
}
/**
   * Input
   */
:host([data-render-mode="shadow"]) [part='input'] {
  padding-inline-start: var(--slds-c-inputtext-spacing-inlinestart, var(--slds-g-spacing-3, 0.75rem));
  padding-inline-end: var(--slds-c-inputtext-spacing-inlineend, var(--slds-g-spacing-4, 1rem));
  height: unset;
  font-family: var(--slds-g-font-family, system-ui, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, 'Helvetica Neue', Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol');
}
/**
   * Focus / active State
   */
...
:host(:not([disabled])) [part='input-container']:active {
  --sds-c-inputtext-color-border: var(--slds-g-color-border-accent-1, #0176d3);
  --sds-c-inputtext-shadow: 0 0 var(--slds-g-sizing-border-3, 3px) var(--slds-g-color-accent-2, var(--lwc-brandPrimaryActive, var(--slds-g-color-brand-base-50)));
  --sds-c-inputtext-color-background: var(--slds-g-color-surface-container-1, #ffffff);
...
:host([data-render-mode="shadow"][readonly]) [part='input-container']:focus-within,:host([data-render-mode="shadow"][readonly]) [part='input-container']:active {
  --sds-c-inputtext-color-border: var(--slds-g-color-disabled-container-2, #c9c9c9);
  --sds-c-inputtext-shadow: 0 0 var(--slds-g-sizing-border-3, 3px) var(--slds-g-color-accent-2, var(--lwc-brandPrimaryActive, var(--slds-g-color-brand-base-50)));
...
:host([data-render-mode="shadow"][invalid]) [part='input-text'] {
  --sds-c-inputtext-shadow: 0 0 0 var(--slds-g-sizing-border-1, 1px) inset var(--slds-g-color-error-1, #ba0517);
  --slds-c-inputtext-color-border: var(--slds-g-color-border-error-1, #ba0517);
  --slds-c-icon-color-foreground: var(--slds-g-color-error-1, #ba0517);
}
...
:host([data-render-mode="shadow"][invalid]) input[type='search'] {
  ...
  --slds-c-input-color-border: var(--slds-g-color-border-error-1, #ba0517);
...
:host([data-render-mode="shadow"][invalid]) input[type='search'] + lightning-primitive-icon::part(icon) {
  fill: var(--slds-g-color-error-1, #ba0517);
...
:host([data-render-mode="shadow"][invalid]) [part='input-container']:focus-within {
  --sds-c-inputtext-shadow:
    var(--slds-g-color-error-base-50, #ea001e) 0 0 0 var(--slds-g-sizing-border-1, 1px) inset,
    0 0 var(--slds-g-sizing-border-3, 3px) var(--slds-g-color-border-error-1, #ba0517);
  --sds-c-inputtext-color-border: var(--slds-g-color-error-1, #ba0517);
}
/**
   * Disabled State
   *
...
:host([data-render-mode="shadow"][disabled]) [part='input-container'],:host([data-render-mode="shadow"][disabled]) [part='input'] {
  ...
  --sds-c-inputtext-color-background: var(
    ...
    var(--slds-g-color-disabled-container-1, #ffffff)
  );
  --sds-c-inputtext-color-border: var(--slds-g-color-border-disabled-1, #c9c9c9);
  --sds-c-inputtext-text-color: var(--slds-g-color-on-disabled-2, #939393);
}
:host([data-render-mode="shadow"][disabled]) [part='input-text'] {
  --sds-c-inputtext-text-color-placeholder: var(--slds-g-color-on-disabled-2, #939393);
}
/**
   * Label
   *
...
:host([data-render-mode="shadow"]) [part='input-text'] [part='label'] {
  ...
  color: var(--slds-c-inputtext-label-color, var(--slds-g-color-on-surface-2, #2e2e2e));
  margin-block-end: var(--slds-g-sizing-1, 0.125rem);
...
:host([data-render-mode="shadow"]) [part='start'] {
  --slds-c-icon-spacing-inlineend: var(--slds-g-spacing-2, 0.5rem);
}
/**
...
:host([data-render-mode="shadow"]) input[type='search'] + lightning-primitive-icon::part(icon) {
  left: var(--slds-g-spacing-3, 0.75rem);
  fill: var(--slds-g-color-on-surface-1, #747474);
}
...
.slds-input-has-icon .slds-button_icon:hover {
  --slds-c-icon-color-foreground: var(--slds-g-color-accent-3, #0b5cab);
}
...
:host([data-render-mode="shadow"]) .slds-input-has-icon_left {
  --slds-c-inputtext-spacing-inlinestart: var(--slds-g-spacing-6, 2rem);
}
...
.slds-input-has-icon_left-right .slds-input__icon_left {
  inset-inline-start: var(--slds-g-spacing-3, 0.75rem);
}
:host([data-render-mode="shadow"]) .slds-input-has-icon_left lightning-primitive-icon::part(icon) {
  /* Native Shadow CSS deviates from synthetic in that it does not require different styling for inline variant */
  left: var(--slds-g-spacing-2, 0.5rem);
}
/**
   * Has Icon Right
   */
:host([data-render-mode="shadow"]) .slds-input-has-icon_right {
  --slds-c-inputtext-spacing-inlineend: var(--slds-g-spacing-6, 2rem);
}
...
.slds-input-has-icon_left-right .slds-input__icon_right {
  inset-inline-end: var(--slds-g-spacing-3, 0.75rem);
}
/**
   * Has Icon Left & Right
   */
