<template>
    ...
    <template if:true={computedShowDateFormat}>
        <div id="fmt-text" data-name={name} data-date-format class={computedClassFormatText} >{dateFormatText}</div>
    </template>
    <div id="error-message" data-name={name} class="slds-form-element__help" data-error-message aria-live="polite">
