           ...
           data-action-triggers="enter">
            ...
            <template if:true={hasIcon}>
                <div class="slds-grid slds-grid_vertical-align-center slds-has-flexi-truncate">
                    <template lwc:if={imgSrc}>
                        <img
                            class="slds-m-right_xx-small slds-icon_x-small"
                            src={imgSrc}
                            alt={def.label}
                            title={def.label}
                    ...
                    <lightning-primitive-icon
                         class="slds-icon_container private-dt-sort-icon_container"
                         svg-class="slds-icon slds-icon-text-default slds-is-sortable__icon private-dt-sort-icon"
