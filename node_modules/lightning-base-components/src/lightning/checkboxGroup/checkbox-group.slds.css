...
:host([data-render-mode="shadow"]) .slds-checkbox__label {
  pointer-events: initial;
}

:host([data-render-mode="shadow"]) .slds-checkbox {
  ...
  */
  ...
  --_slds-c-checkboxgroup-shadow: var(--slds-c-checkbox-shadow);
  --_slds-c-checkboxgroup-shadow-focus: var(--slds-c-checkbox-shadow-focus);
  --_slds-c-checkboxgroup-color-background: var(--slds-c-checkbox-color-background);
  --_slds-c-checkboxgroup-color-background-checked: var(--slds-c-checkbox-color-background-checked);
  --_slds-c-checkboxgroup-color-border: var(--slds-c-checkbox-color-border);
  --_slds-c-checkboxgroup-color-border-checked: var(--slds-c-checkbox-color-border-checked);
  --_slds-c-checkboxgroup-color-border-focus: var(--slds-c-checkbox-color-border-focus);
  --_slds-c-checkboxgroup-mark-color-foreground: var(--slds-c-checkbox-mark-color-foreground);
  --_slds-c-checkboxgroup-radius-border: var(--slds-c-checkbox-radius-border);
}

:host([data-render-mode="shadow"]) .slds-form-element__control .slds-checkbox {
  display: block;
}
...
:host([data-render-mode="shadow"]) .slds-checkbox .slds-checkbox_faux {
  ...
  border-radius: var(--_slds-c-checkboxgroup-radius-border, var(--slds-g-radius-border-1, 0.125rem));
  border-width: var(--slds-s-mark-sizing-border, var(--slds-g-sizing-border-1, 1px));
  border-style: solid;
  border-color: var(
    --_slds-c-checkboxgroup-color-border,
    var(--slds-s-mark-color-border, var(--slds-g-color-border-2, var(--slds-g-color-neutral-base-50)))
  );
  background-color: var(
    --_slds-c-checkboxgroup-color-background,
    var(--slds-s-mark-color-background, var(--slds-g-color-surface-container-1, #ffffff))
  );
...
:host([data-render-mode="shadow"]) .slds-checkbox .slds-checkbox__label .slds-form-element__label {
...
:host([data-render-mode="shadow"]) .slds-checkbox [type='checkbox'] {
  width: 1px;
  height: 1px;
  border: 0;
  clip: rect(0 0 0 0);
...
.slds-checkbox [type='checkbox']:checked + .slds-checkbox__label .slds-checkbox_faux {
  --_slds-c-checkboxgroup-color-background: var(
    ...
    var(--slds-s-mark-color-background-checked, var(--slds-g-color-surface-container-1, #ffffff))
  );
}
...
.slds-checkbox [type='checkbox']:checked + .slds-checkbox__label .slds-checkbox_faux::after {
  display: block;
  content: '';
  height: var(--slds-g-sizing-2, 0.25rem);
  width: var(--slds-g-sizing-3, 0.5rem);
  position: absolute;
  inset-block-start: 50%;
  left: 50%;
  transform: translate3d(-50%, -50%, 0) rotate(-45deg);
  border-block-end: var(--slds-g-sizing-border-2, 2px) solid
    var(
      --_slds-c-checkboxgroup-mark-color-foreground,
      var(--slds-s-mark-color-foreground-checked, var(--slds-g-color-border-accent-1, #0176d3))
    );
  border-inline-start: var(--slds-g-sizing-border-2, 2px) solid
    var(
      --_slds-c-checkboxgroup-mark-color-foreground,
      var(--slds-s-mark-color-foreground-checked, var(--slds-g-color-border-accent-1, #0176d3))
    );
...
.slds-checkbox:dir(rtl) [type='checkbox']:checked + .slds-checkbox__label .slds-checkbox_faux::after {
  ...
  border-inline-end: var(--slds-g-sizing-border-2, 2px) solid
    var(
      --_slds-c-checkboxgroup-mark-color-foreground,
      var(--slds-s-mark-color-foreground-checked, var(--slds-g-color-border-accent-1, #0176d3))
    );
...
.slds-checkbox [type='checkbox']:focus + .slds-checkbox__label .slds-checkbox_faux {
  --_slds-c-checkboxgroup-color-border: var(
    ...
    var(--slds-s-input-color-border-focus, var(--slds-g-color-border-accent-1, #0176d3))
  );
  --_slds-c-checkboxgroup-shadow: var(
    --_slds-c-checkboxgroup-shadow-focus,
    var(--slds-s-mark-shadow-focus, 0 0 3px var(--slds-g-color-accent-2, var(--lwc-brandPrimaryActive, var(--slds-g-color-brand-base-50))))
  );
}
...
.slds-checkbox [type='checkbox'][disabled]:checked + .slds-checkbox__label .slds-checkbox_faux {
  border-color: var(--slds-g-color-border-disabled-1, #c9c9c9);
  background-color: var(--slds-s-mark-color-background, var(--slds-g-color-disabled-container-2, #c9c9c9));
}
...
.slds-checkbox [type='checkbox'][disabled] + .slds-checkbox__label .slds-checkbox_faux::after {
  border-color: var(--slds-g-color-on-disabled-2, #939393);
}
...
:host([data-render-mode="shadow"].slds-has-error) .slds-checkbox [type='checkbox'] + .slds-checkbox_faux,:host([data-render-mode="shadow"].slds-has-error) .slds-checkbox [type='checkbox'] ~ .slds-checkbox_faux,:host([data-render-mode="shadow"].slds-has-error) .slds-checkbox [type='checkbox'] + .slds-checkbox__label .slds-checkbox_faux {
  border-color: var(--slds-g-color-border-error-1, #ba0517);
  border-width: var(--slds-g-sizing-border-2, 2px);
}
...
:host([data-render-mode="shadow"].slds-has-error) .slds-checkbox [type='checkbox']:checked + .slds-checkbox_faux::after,:host([data-render-mode="shadow"].slds-has-error) .slds-checkbox [type='checkbox']:checked ~ .slds-checkbox_faux::after,:host([data-render-mode="shadow"].slds-has-error)
  ...
  border-color: var(--slds-s-mark-color-foreground-invalid, var(--slds-g-color-border-error-1, #ba0517));
}
...
:host([data-render-mode="shadow"][variant='label-stacked']) {
  padding: 0 var(--slds-g-spacing-1, 0.25rem);
