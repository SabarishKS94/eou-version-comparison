...
:host([data-render-mode="shadow"]) .slds-radio .slds-radio_faux {
  ...
  /* stylelint-disable */
  border: 1px solid var(--slds-c-radio-color-border, var(--slds-g-color-border-1, var(--slds-g-color-neutral-base-80)));
  /* stylelint-enable */
  border-radius: var(--slds-g-radius-border-circle, 100%);
  background: none;
  /* stylelint-disable */
  background-color: var(--slds-c-radio-color-background, var(--slds-g-color-surface-container-1, #ffffff));
...
.slds-radio_button [type='radio'] {
  width: var(--slds-g-sizing-1, 0.125rem);
  height: var(--slds-g-sizing-1, 0.125rem);
  border: 0;
  clip: rect(0 0 0 0);
  margin: -1px;
  overflow: hidden;
...
.slds-radio [type='radio']:checked + .slds-radio__label .slds-radio_faux {
  /* stylelint-disable */
  border-color: var(--slds-c-radio-color-border-checked, var(--slds-g-color-border-1, var(--slds-g-color-neutral-base-80)));
  background: none;
  background-color: var(--slds-c-radio-color-background-checked, var(--slds-g-color-surface-container-1, #ffffff));
  /* stylelint-enable */
}
...
.slds-radio [type='radio']:checked + .slds-radio__label .slds-radio_faux::after {
  ...
  height: var(--slds-g-sizing-3, 0.5rem);
  content: '';
  position: absolute;
  top: 50%;
  ...
  background: none;
  /* stylelint-disable */
  background-color: var(--slds-c-radio-mark-color-foreground, var(--slds-g-color-accent-container-2, var(--lwc-brandAccessibleActive, var(--slds-g-color-brand-base-40))));
}
...
.slds-radio [type='radio']:focus + .slds-radio__label .slds-radio_faux {
  border-color: var(--slds-c-radio-color-border-focus, var(--slds-g-color-accent-1, var(--lwc-brandPrimary, var(--slds-g-color-brand-base-60))));
  box-shadow: var(--slds-c-radio-shadow-focus, 0 0 3px var(--slds-g-color-accent-2, var(--lwc-brandPrimaryActive, var(--slds-g-color-brand-base-50))));
  /* stylelint-enable */
}
...
.slds-radio [type='radio'][disabled] + .slds-radio__label .slds-radio_faux::after {
  background: var(--slds-g-color-neutral-base-60, #939393);
}
...
:host([data-render-mode="shadow"].slds-has-error) .slds-radio [type='radio'] + .slds-radio_faux,:host([data-render-mode="shadow"].slds-has-error) .slds-radio [type='radio'] ~ .slds-radio_faux,:host([data-render-mode="shadow"].slds-has-error) .slds-radio [type='radio'] + .slds-radio__label .slds-radio_faux {
  border-color: var(--slds-g-color-error-base-40, #ba0517);
...
:host([data-render-mode="shadow"]) .slds-button:focus {
  box-shadow: 0 0 3px var(--slds-g-color-accent-2, var(--lwc-brandPrimaryActive, var(--slds-g-color-brand-base-50)));
  outline: 0;
  padding: 30px;
}
...
:host([data-render-mode="shadow"]) .slds-radio_button + .slds-radio_button {
  border-inline-start: var(--slds-g-sizing-border-1, 1px) solid var(--slds-g-color-border-1, var(--slds-g-color-neutral-base-80));
  margin: 0;
}
...
.slds-radio_button:first-child > .slds-radio_faux {
  border-start-start-radius: var(--slds-g-radius-border-2, 0.25rem);
  border-end-start-radius: var(--slds-g-radius-border-2, 0.25rem);
}
...
.slds-radio_button:last-child > .slds-radio_button__label {
  border-start-end-radius: var(--slds-g-radius-border-2, 0.25rem);
  border-end-end-radius: var(--slds-g-radius-border-2, 0.25rem);
}
...
.slds-radio_button [part='radio']:checked + .slds-radio_button__label {
  background-color: var(--slds-g-color-accent-container-2, var(--lwc-brandAccessibleActive, var(--slds-g-color-brand-base-40)));
  color: var(--slds-g-color-on-accent-1, var(--slds-g-color-brand-base-100));
}
...
.slds-radio_button [part='radio']:checked + .slds-radio_button__label:focus {
  background-color: var(--slds-g-color-accent-container-3, #014486);
}
...
.slds-radio_button [part='radio'][disabled] + .slds-radio_button__label {
  ...
  color: var(--slds-g-color-disabled-1, #c9c9c9);
}
