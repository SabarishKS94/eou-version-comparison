    ...
    <div class="slds-accordion__list-item">
        <section class={computedSectionClasses} part="accordion-section">
            <div class="slds-accordion__summary">
                <h2 lwc:ref="header" aria-level={_privateHeadingAriaLevel} onkeydown={handleKeyDown} class={computedHeaderClass}>
                    <button
                ...
                <slot name="actions" onslotchange={handleSlotChange}></slot>
            </div>
