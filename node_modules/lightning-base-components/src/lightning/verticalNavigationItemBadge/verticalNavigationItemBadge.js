...
export default class LightningVerticalNavigationItemBadge extends LightningShadowBaseClass {
    ...
    get ariaCurrent() {
        return this._selected && this._rendered
            ? 'page'
            : false;
    }
    get showBadge() {
