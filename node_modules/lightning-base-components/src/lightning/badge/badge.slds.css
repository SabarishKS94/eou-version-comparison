...
:host([data-render-mode="shadow"]) [part='badge'] {
  ...
  color: var(--slds-c-badge-text-color, var(--slds-g-color-on-surface-3, #181818));
  ...
  /* stylelint-enable */
  white-space: nowrap;
  border-width: var(--slds-c-badge-sizing-border, var(--slds-g-sizing-border-1, 1px));
  border-style: solid;
  border-color: var(--slds-c-badge-color-border, transparent);
  border-radius: var(--slds-c-badge-radius-border, 15rem);
  background-color: var(--slds-c-badge-color-background, var(--slds-g-color-neutral-base-95, #f3f3f3));
}
...
:host([data-render-mode="shadow"]) [part='badge'] .slds-badge__icon {
  ...
  color: var(
    ...
    var(--slds-g-color-neutral-base-50, #747474, var(--slds-g-color-neutral-base-50, #747474))
  );
  line-height: 1;
...
:host([data-render-mode="shadow"].slds-badge_inverse) {
  ...
  --slds-c-badge-text-color: var(
    ...
    var(--slds-g-color-neutral-base-100, #ffffff, var(--slds-g-color-neutral-base-100, #ffffff))
  );
}
...
:host([data-render-mode="shadow"].slds-badge_lightest) {
  ...
  --slds-c-badge-color-border: var(
    ...
    var(--slds-g-color-border-base-1, var(--slds-g-color-neutral-base-90, #e5e5e5))
  );
}
