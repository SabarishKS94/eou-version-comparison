/*******************************************
* Imported dependency from @salesforce-ux/sds-components/src/sds/icon/icon.css
*******************************************/
...
.slds-icon_x-small {
  --slds-c-icon-sizing: var(--slds-g-sizing-5, 1rem);
}
...
.slds-icon_large {
  --slds-c-icon-sizing: var(--slds-g-sizing-10, 3rem);
}
:host([data-render-mode="shadow"][variant='warning']) {
  --slds-c-icon-color-foreground: var(--slds-g-color-warning-1, #fe9339);
}
:host([data-render-mode="shadow"][variant='success']) {
  --slds-c-icon-color-foreground: var(--slds-g-color-success-1, #2e844a);
}
...
:host([data-render-mode="shadow"][variant='light']) {
  --slds-c-icon-color-foreground: var(--slds-g-color-neutral-base-70, #aeaeae);
}
:host([data-render-mode="shadow"]) [part='boundary'] {
  /* --sds-c-icon-color-background: var(--slds-c-icon-color-background); */
  --sds-c-icon-radius-border: var(--slds-c-icon-radius-border, var(--slds-g-radius-border-2, 0.25rem));
  --sds-c-icon-sizing-border: var(--slds-c-icon-sizing-border, 0);
  --sds-c-icon-color-border: var(--slds-c-icon-color-border);
  --sds-c-icon-spacing-block-start: var(--slds-c-icon-spacing-blockstart, var(--slds-c-icon-spacing-block));
...
:host([data-render-mode="shadow"]) .slds-input__icon [part='boundary'] {
  border-style: none;
}
:host([data-render-mode="shadow"]) [part='icon'] {
  --sds-c-icon-color-foreground: var(--slds-c-icon-color-foreground, var(--slds-g-color-on-accent-1, var(--slds-g-color-brand-base-100)));
  --sds-c-icon-sizing-height: var(
    --slds-c-icon-sizing-height,
    var(--slds-c-icon-sizing, var(--slds-g-sizing-9, 2rem))
  );
...
.slds-icon_container_circle {
  --slds-c-icon-spacing-block: var(--slds-g-sizing-3, 0.5rem);
  --slds-c-icon-spacing-inline: var(--slds-g-sizing-3, 0.5rem);
  --slds-c-icon-radius-border: calc(var(--slds-g-radius-border-circle, 100%) / 2);
  --slds-c-icon-sizing-border: var(--slds-g-sizing-3, 0.5rem);
}
/**
 * P R I V A T E
 *
 ...
 */
:host([data-render-mode="shadow"]) .slds-icon {
  display: inline-flex;
  height: var(
    --slds-c-icon-sizing-height,
    var(--slds-c-icon-sizing, var(--slds-s-icon-sizing, var(--slds-g-sizing-9, 2rem)))
  );
  width: var(
    --slds-c-icon-sizing-width,
    var(--slds-c-icon-sizing, var(--slds-s-icon-sizing, var(--slds-g-sizing-9, 2rem)))
  );
  fill: var(--slds-c-icon-color-foreground, var(--slds-g-color-neutral-base-100, #ffffff));
}
:host([data-render-mode="shadow"]) .slds-icon-text-default {
  /*! @css-var-fallback fill */
  --slds-c-icon-color-foreground: var(
    --slds-c-icon-color-foreground-default,
    var(--sds-c-icon-color-foreground-default, var(--slds-g-color-on-surface-1, #747474))
  );
}
:host([data-render-mode="shadow"]) .slds-icon-text-default.slds-is-disabled {
  fill: var(--slds-g-color-disabled-1, #c9c9c9);
}
/**
