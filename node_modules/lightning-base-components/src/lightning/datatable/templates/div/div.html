<template>
    ...
    <span aria-live="polite">
        ...
        <span
            ...
            class={computedAriaLiveClassForNavMode}
            >{i18n.ariaLiveNavigationMode}</span
        >
        <span
            data-keyboard-mode="action"
            class={computedAriaLiveClassForActionMode}
            >{i18n.ariaLiveActionMode}</span
        >
    </span>
    <div
        lwc:ref="widthObserver"
        lwc:dom="manual"
        class="dt-width-observer"
        style="width: 100%; height: 0px"
    ></div>
    <div
        lwc:ref="outerContainer"
        part="datagrid-wrapper"
        class="dt-outer-container"
        style="height: 100%; position: relative"
    >
        <!-- Inline Edit Panel -->
        <lightning-primitive-datatable-iedit-panel
            data-iedit-panel="true"
            custom-error-validation-message={state.inlineEdit.customErrorValidationMessage}
        ...
        <div
            ...
            style={computedScrollerXStyle}
        >
            <div
                lwc:ref="scrollerY"
                class="slds-scrollable_y"
                onscroll={handleVerticalScroll}
                style={computedScrollerYStyle}
            >
                <!-- Corresponds to <table> -->
                <div
                    lwc:ref="tableElement"
                ...
                >
                    ...
                    <template if:true={hasValidKeyField}>
                        ...
                        >
                            ...
                            <!-- Column Header Row -->
                            <div
                                class="slds-line-height_reset table-header"
                                role="row"
                                aria-rowindex="1"
                                lwc:ref="headerRow"
                                    ...
                                    >
                                        <template if:true={def.fixedWidth}>
                                            ...
                                            <lightning-primitive-header-factory
                                                ...
                                                header-id={computedCheckboxColumnHeaderId}
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >
                                                    <template
                                                        if:true={cell.isCustomBareLayout}
                                                    >
                                                        <div
                                                            class={cell.computedCellDivClass}
                                                            style={cell.computedCellDivStyle}
                                                        >
                                                            <!-- custom type with bare layout -->
                                                            <template
                                                                if:true={consolidateTypeAttributes}
                                                            >
                                                                <lightning-primitive-custom-cell
                                                                    ...
                                                                    cell-type-attributes={cell.typeAttributes}
                                                                >
                                                                </lightning-primitive-custom-cell>
                                                            </template>
                                                            <template
                                                                if:false={consolidateTypeAttributes}
                                                            >
                                                                <lightning-primitive-custom-cell
                                                                    types={_privateTypes}
                                                                    row-key-value={row.key}
                                                    ...
                                                    <template
                                                        if:false={cell.isCustomBareLayout}
                                                    >
                                                        <span
                                                            class={cell.computedWrapperClass}
                                                            data-cell-type={cell.columnType}
                                                        >
                                                            <!-- tree toggle -->
                                                            <template
                                                                if:true={cell.hasTreeData}
                                                            >
                                                                <template
                                                                    if:true={consolidateTypeAttributes}
                                                                >
                                                                    <lightning-primitive-treegrid-cell-toggle
                                                                        ...
                                                                        row-toggle-icon={rowToggleIcon}
                                                                        url-label={cell.urlLabel}
                                                                        value={cell.value}
                                                                        has-children={cell.treeAttributes.hasChildren}
                                                                        is-expanded={cell.treeAttributes.isExpanded}
                                                                    >
                                                                    </lightning-primitive-treegrid-cell-toggle>
                                                                </template>
                                                                <template
                                                            ...
                                                            <div
                                                                class={cell.computedCellDivClass}
                                                                style={cell.computedCellDivStyle}
                                                                data-editable={cell.isEditable}
                                                            >
                                                                <!-- *************** PREFIX ICONS DO NOT ADD ANY TYPE BEFORE THIS *************** -->

                                                                <!-- left icon -->
                                                                <template
                                                                    if:true={cell.hasLeftIcon}
                                                                >
                                                                    <lightning-icon
                                                                ...
                                                                <!-- boolean -->
                                                                <template
                                                                    if:true={cell.isBoolean}
                                                                >
                                                                    <template
                                                                        if:true={cell.isChecked}
                                                                    >
                                                                        <!-- Caution: Modify generate-inlined-icons script before changing comments -->
                                                                        <!-- START utility:check -->
                                                                        <template lwc:if={cell.isRTL}>
                                                                            <svg class="slds-icon slds-icon-text-default slds-icon_x-small" focusable="false" data-key="check" aria-hidden="true" viewBox="0 0 520 520" part="button-icon icon">
                                                                                <g>
                                                                    ...
                                                                    <span
                                                                        ...
                                                                        >{cell.booleanCellAssistiveText}</span
                                                                    >
                                                                </template>

                                                                <!-- currency -->
                                                                <template
                                                                    if:true={cell.isCurrency}
                                                                >
                                                                    <span
                                                                ...
                                                                <template
                                                                    if:true={cell.isCustomStandardLayout}
                                                                >
                                                                    <template
                                                                        if:true={consolidateTypeAttributes}
                                                                    >
                                                                ...
                                                                <!-- email -->
                                                                <template
                                                                    if:true={cell.isEmail}
                                                                >
                                                                    <template
                                                                        if:true={cell.showEmailLink}
                                                                    >
                                                                        <a
                                                                        ...
                                                                        >
                                                                            <template
                                                                                if:false={cell.emailIconHidden}
                                                                            >
                                                                                <!-- Caution: Modify generate-inlined-icons script before changing comments -->
                                                                                <!-- START utility:email -->
                                                                                <template lwc:if={cell.isRTL}>
                                                                                    <svg class="slds-icon slds-icon-text-default slds-icon_x-small slds-m-right_x-small" focusable="false" data-key="email" aria-hidden="true" viewBox="0 0 520 520" part="button-icon icon">
                                                                                        <g>
                                                                                ...
                                                                                <span
                                                                                    class="slds-assistive-text"
                                                                                    >{cell.emailIconAssistiveText}</span
                                                                                >
                                                                            </template>
                                                                            {cell.emailLabel}
                                                                        </a>
                                                                ...
                                                                <!-- location -->
                                                                <template
                                                                    if:true={cell.isLocation}
                                                                >
                                                                    <template
                                                                        if:true={cell.hasLeftIcon}
                                                                    >
                                                                        <span
                                                                            >{cell.locationValue}</span
                                                                        >
                                                                    </template>
                                                                    <template
                                                                        if:false={cell.hasLeftIcon}
                                                                    >
                                                                        {cell.locationValue}
                                                                    </template>
                                                                </template>
                                                                ...
                                                                <!-- phone -->
                                                                <template
                                                                    if:true={cell.isPhone}
                                                                >
                                                                    <template
                                                                        if:true={cell.showPhoneLink}
                                                                    >
                                                                        <a
                                                                            data-action-triggers="enter"
                                                                ...
                                                                <!-- lookup (reference) -->
                                                                <template
                                                                    if:true={cell.isLookup}
                                                                >
                                                                    <template
                                                                        if:true={cell.lookupIsNavigable}
                                                                    >
                                                                        <a
                                                                            data-action-triggers="enter"
                                                                    ...
                                                                    <template
                                                                        if:false={cell.lookupIsNavigable}
                                                                    >
                                                                        <span
                                                                            data-inline-type="formatted-lookup"
                                                                            data-navigation="enable"
                                                                ...
                                                                <!-- row number -->
                                                                <template
                                                                    if:true={cell.isRowNumber}
                                                                >
                                                                    <template
                                                                        if:true={cell.rowHasError}
                                                                    >
                                                                        <template
                                                                            if:true={consolidateTypeAttributes}
                                                                        >
                                                                            <lightning-primitive-datatable-tooltip
                                                                                ...
                                                                                size="xx-small"
                                                                                header={cell.typeAttributes.error.title}
                                                                                content={cell.typeAttributes.error.messages}
                                                                                variant="error"
                                                                                internal-tab-index={cell.internalTabIndex}
                                                                                alternative-text={cell.typeAttributes.error.alternativeText}
                                                                            >
                                                                            </lightning-primitive-datatable-tooltip>
                                                                        </template>
                                                                        <template
                                                                ...
                                                                >
                                                                    <template
                                                                        if:false={cell.shouldFormatText}
                                                                    >
                                                                        <template
                                                                            if:true={cell.ignoreRTL}
                                                                        >
                                                                            <span
                                                                                dir="ltr"
                                                                                >{cell.textValue}</span
                                                                    ...
                                                                    <template
                                                                        if:true={cell.shouldFormatText}
                                                                    >
                                                                        <span>
                                                                            <template
                                                                                for:each={cell.textParts}
                                                                                for:item="part"
                                                                            >
                                                                                <template
                                                                                    if:true={part.isLink}
                                                            ...
                                                            >
                                                                <button
                                                                    ...
                                                                    data-navigation="enable"
                                                                    tabindex={cell.internalTabIndex}
                                                                    style={cell.computedEditButtonStyle}
                                                                    onclick={handleInlinedEditButtonClick}
                                                                >
                                                                    <!-- Caution: Modify generate-inlined-icons script before changing comments -->
                                                                    <!-- START utility:edit -->
                                                                    <template lwc:if={cell.isRTL}>
                                                                        <svg class="slds-button__icon slds-button__icon_hint slds-button__icon_lock slds-button__icon_edit slds-icon slds-icon-text-default slds-icon_xx-small" focusable="false" data-key="edit" aria-hidden="true" viewBox="0 0 520 520" part="button-icon icon">
                                                                            <g>
                                                            ...
                                                            <template
                                                                if:true={cell.shouldDisplayReadOnlyIcon}
                                                            >
                                                                ...
                                                                <span aria-label={cell.readOnlyIconAlternativeText} role="img">
                                                                    <!-- Caution: Modify generate-inlined-icons script before changing comments -->
                                                                    <!-- START utility:lock -->
                                                                    <template lwc:if={cell.isRTL}>
                                                                        <svg class="slds-button__icon slds-button__icon_hint slds-button__icon_lock slds-button__icon_edit slds-icon slds-icon-text-default slds-icon_xx-small" focusable="false" data-key="lock" aria-hidden="true" viewBox="0 0 520 520" part="button-icon icon">
                                                                            <g>
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <lightning-primitive-cell-factory
                                                            ...
                                                            is-custom-type={cell.isCustom}
                                                            is-custom-bare-layout={cell.isCustomBareLayout}
                                                            editable={cell.editable}
                                                            is-edit-hidden={cell.isEditHidden}
                                                            display-read-only-icon={cell.displayReadOnlyIcon}
                                                            cell-type-attributes={cell.typeAttributes}
                                                            tree-attributes={cell.treeAttributes}
                                                        >
                                                        </lightning-primitive-cell-factory>
                                                    </template>
                                                    <template
